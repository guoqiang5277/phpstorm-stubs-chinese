...
class SyncMutex
{
     ...
     * @link https://php.net/manual/zh/syncmutex.construct.php
     */
...
class SyncSemaphore
{
     ...
     * @link https://php.net/manual/zh/syncsemaphore.construct.php
     */
...
class SyncEvent
{
     ...
     * @link https://php.net/manual/zh/syncevent.construct.php
     */
...
class SyncReaderWriter
{
     ...
     * @link https://php.net/manual/zh/syncreaderwriter.construct.php
     */
...
class SyncSharedMemory
{
     ...
     * @link https://php.net/manual/zh/syncsharedmemory.construct.php
     */
