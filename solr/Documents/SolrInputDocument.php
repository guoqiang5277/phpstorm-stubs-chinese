...
final class SolrInputDocument
{
     ...
     * @link https://php.net/manual/zh/solrinputdocument.addchilddocument.php
     ...
     * @link https://php.net/manual/zh/solrinputdocument.addchilddocuments.php
     * @param array &$docs <p>
     ...
     * @link https://php.net/manual/zh/solrinputdocument.addfield.php
     ...
     * @link https://php.net/manual/zh/solrinputdocument.clear.php
     * @return bool <p>
     * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrinputdocument.clone.php
     */
     ...
     * @link https://php.net/manual/zh/solrinputdocument.construct.php
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/zh/solrinputdocument.destruct.php
     */
     ...
     * @link https://php.net/manual/zh/solrinputdocument.fieldexists.php
     * @param string $fieldName <p>
     * Name of the field.
     * </p>
     * @return bool <p>
     ...
     * @link https://php.net/manual/zh/solrinputdocument.getboost.php
     ...
     * @link https://php.net/manual/zh/solrinputdocument.getchilddocuments.php
     ...
     * @link https://php.net/manual/zh/solrinputdocument.getchilddocumentscount.php
     * @return int
     */
     ...
     * @link https://php.net/manual/zh/solrinputdocument.getfield.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     ...
     * @link https://php.net/manual/zh/solrinputdocument.getfieldboost.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     * @return float|false <p>
     ...
     * @link https://php.net/manual/zh/solrinputdocument.getfieldcount.php
     * @return int|false <p>
     ...
     * @link https://php.net/manual/zh/solrinputdocument.getfieldnames.php
     ...
     * @link https://php.net/manual/zh/solrinputdocument.haschilddocuments.php
     * @return bool <p>
     ...
     * @link https://php.net/manual/zh/solrinputdocument.merge.php
     ...
     * @link https://php.net/manual/zh/solrinputdocument.reset.php
     * @return bool <p>
     * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrinputdocument.setboost.php
     ...
     * https://php.net/manual/zh/solrinputdocument.setfieldboost.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     ...
     * @link https://php.net/manual/zh/solrinputdocument.sort.php
     ...
     * @link https://php.net/manual/zh/solrinputdocument.toarray.php
     * @return array|false <p>
