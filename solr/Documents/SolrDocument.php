 ...
 * @link https://php.net/manual/zh/class.solrinputdocument.php
 */
final class SolrDocument implements ArrayAccess, Iterator, Serializable
{
     ...
     * @link https://php.net/manual/zh/solrdocument.addfield.php
     ...
     * @link https://php.net/manual/zh/solrdocument.clear.php
     * @return bool <p>
     * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.clone.php
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.construct.php
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.current.php
     ...
     * @link https://php.net/manual/zh/solrdocument.deletefield.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     * @return bool <p>
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/zh/solrdocument.destruct.php
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.fieldexists.php
     * @param string $fieldName <p>
     * Name of the field.
     * </p>
     * @return bool <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.get.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     * @return SolrDocumentField <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.getchilddocuments.php
     ...
     * @link https://php.net/manual/zh/solrdocument.getchilddocumentscount.php
     * @return int
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.getfield.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     ...
     * @link https://php.net/manual/zh/solrdocument.getfieldcount.php
     * @return int|false <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.getfieldnames.php
     ...
     * @link https://php.net/manual/zh/solrdocument.getinputdocument.php
     ...
     * @link https://php.net/manual/zh/solrdocument.haschilddocuments.php
     * @return bool <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.isset.php
     * @param string $fieldName <p>
     * Name of the field.
     * </p>
     * @return bool <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.key.php
     * @return string <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.merge.php
     ...
     * @link https://php.net/manual/zh/solrdocument.next.php
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.offsetexists.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     * @return bool <p>
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Retrieves a field
     * @link https://php.net/manual/zh/solrdocument.offsetget.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     * @return SolrDocumentField <p>
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Adds a field to the document
     * @link https://php.net/manual/zh/solrdocument.offsetset.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     * @param string $fieldValue <p>
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Removes a field
     * @link https://php.net/manual/zh/solrdocument.offsetunset.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.reset.php
     * @return bool <p>
     * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.rewind.php
     */
     ...
     * @link https://php.net/manual/zh/solrdocument.serialize.php
     * @return string <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.set.php
     * @param string $fieldName <p>
     * Name of the field.
     * </p>
     * @param string $fieldValue <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.sort.php
     ...
     * @link https://php.net/manual/zh/solrdocument.unserialize.php
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Removes a field from the document
     * @link https://php.net/manual/zh/solrdocument.unset.php
     * @param string $fieldName <p>
     * The name of the field.
     * </p>
     * @return bool <p>
     ...
     * @link https://php.net/manual/zh/solrdocument.valid.php
     * @return bool <p>
     * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * </p>
     */
