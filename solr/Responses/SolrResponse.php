 ...
 * @link https://php.net/manual/zh/class.solrresponse.php
 */
abstract class SolrResponse
{
     ...
     * @link https://php.net/manual/zh/solrresponse.getdigestedresponse.php
     * @return string <p>
     * Returns the XML response as serialized PHP data
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrresponse.gethttpstatus.php
     * @return int <p>
     * Returns the HTTP status of the response.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrresponse.gethttpstatusmessage.php
     * @return string <p>
     * Returns more details on the HTTP status
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrresponse.getrawrequest.php
     * @return string <p>
     * Returns the raw request sent to the Solr server
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrresponse.getrawrequestheaders.php
     * @return string <p>
     * Returns the raw request headers sent to the Solr server
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrresponse.getrawresponse.php
     * @return string <p>
     * Returns the raw response from the server.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrresponse.getrawresponseheaders.php
     * @return string <p>
     * Returns the raw response headers from the server.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrresponse.getrequesturl.php
     * @return string <p>
     * Returns the full URL the request was sent to
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrresponse.getresponse.php
     * @return SolrObject <p>
     * Returns a SolrObject representing the XML response from the server
     * </p>
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Sets the parse mode
     * @link https://php.net/manual/zh/solrresponse.setparsemode.php
     ...
     * @link https://php.net/manual/zh/solrresponse.success.php
     * @return bool <p>
