 ...
 * @link https://php.net/manual/zh/class.solrpingresponse.php
 */
final class SolrPingResponse extends SolrResponse
{
     ...
     * @link https://php.net/manual/zh/solrpingresponse.construct.php
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/zh/solrpingresponse.destruct.php
     */
     ...
     * @link https://php.net/manual/zh/solrpingresponse.getresponse.php
     * @return string <p>
