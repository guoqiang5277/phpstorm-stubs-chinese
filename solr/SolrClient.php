 ...
 * not supported.
 * @link https://php.net/manual/zh/class.solrclient.php
 */
final class SolrClient
{
     ...
     * @link https://php.net/manual/zh/solrclient.adddocument.php
     ...
     * @link https://php.net/manual/zh/solrclient.adddocuments.php
     * @param array $docs <p>
     ...
     * @link https://php.net/manual/zh/solrclient.commit.php
     ...
     * @link https://php.net/manual/zh/solrclient.construct.php
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Delete by Id
     * @link https://php.net/manual/zh/solrclient.deletebyid.php
     * @param string $id <p>
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Deletes by Ids
     * @link https://php.net/manual/zh/solrclient.deletebyids.php
     * @param array $ids <p>
     ...
     * @link https://php.net/manual/zh/solrclient.deletebyqueries.php
     ...
     * @link https://php.net/manual/zh/solrclient.deletebyquery.php
     ...
     * @link https://php.net/manual/zh/solrclient.destruct.php
     */
     ...
     * @link https://php.net/manual/zh/solrclient.getbyid.php
     * @param string $id <p>
     * Document ID
     * </p>
     ...
     * @link https://php.net/manual/zh/solrclient.getbyids.php
     * @param array $ids <p>
     * Document ids
     * </p>
     * @return SolrQueryResponse
     ...
     * @link https://php.net/manual/zh/solrclient.getdebug.php
     * @return string <p>
     ...
     * @link https://php.net/manual/zh/solrclient.getoptions.php
     * @return array <p>
     ...
     * @link https://php.net/manual/zh/solrclient.optimize.php
     ...
     * @link https://php.net/manual/zh/solrclient.ping.php
     ...
     * @link https://php.net/manual/zh/solrclient.query.php
     ...
     * @link https://php.net/manual/zh/solrclient.request.php
     ...
     * @link https://php.net/manual/zh/solrclient.rollback.php
     * @return SolrUpdateResponse <p>
     * Returns a SolrUpdateResponse on success and throws an exception on failure.
     * </p>
     * @throws SolrClientException <p>
     ...
     * @link https://php.net/manual/zh/solrclient.setresponsewriter.php
     ...
     * @link https://php.net/manual/zh/solrclient.setservlet.php
     * @param int $type <p>
     * One of the following :
     * </p>
     * <ul>
     ...
     * @link https://php.net/manual/zh/solrclient.system.php
     ...
     * @link https://php.net/manual/zh/solrclient.threads.php
     * @return SolrGenericResponse <p>
     * Returns a SolrGenericResponse object on success.
     * </p>
     * @throws SolrClientException <p>
