 ...
 * read-only.
 * @link https://php.net/manual/zh/class.solrobject.php
 */
final class SolrObject implements ArrayAccess
{
     ...
     * @link https://php.net/manual/zh/solrobject.construct.php
     */
     ...
     * (PECL solr &gt;= 0.9.2)<br/>
     * Destructor
     * @link https://php.net/manual/zh/solrobject.destruct.php
     */
     ...
     * @link https://php.net/manual/zh/solrobject.getpropertynames.php
     * @return array <p>
     * Returns an array.
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/solrobject.offsetexists.php
     ...
     * @link https://php.net/manual/zh/solrobject.offsetget.php
     * @param string $property_name <p>
     * The name of the property.
     * </p>
     ...
     * @link https://php.net/manual/zh/solrobject.offsetset.php
     * @param string $property_name <p>
     * The name of the property.
     * </p>
     ...
     * @link https://php.net/manual/zh/solrobject.offsetunset.php
     * @param string $property_name <p>
     * The name of the property.
     * </p>
     * @return bool
