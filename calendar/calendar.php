 ...
 * @link https://php.net/manual/zh/function.jdtogregorian.php
 ...
 * @link https://php.net/manual/zh/function.gregoriantojd.php
 * @param int $month <p>
 ...
 * @link https://php.net/manual/zh/function.jdtojulian.php
 * @param int $julian_day <p>
 * A julian day number as integer
 * </p>
 ...
 * @link https://php.net/manual/zh/function.juliantojd.php
 * @param int $month <p>
 * The month as a number from 1 (for January) to 12 (for December)
 * </p>
 * @param int $day <p>
 ...
 * @link https://php.net/manual/zh/function.jdtojewish.php
 ...
 * @link https://php.net/manual/zh/function.jewishtojd.php
 * @param int $month <p>
 ...
 * @link https://php.net/manual/zh/function.jdtofrench.php
 * @param int $julian_day
 ...
 * @link https://php.net/manual/zh/function.frenchtojd.php
 * @param int $month <p>
 ...
 * @link https://php.net/manual/zh/function.jddayofweek.php
 * @param int $julian_day <p>
 * A julian day number as integer
 * </p>
 ...
 * @link https://php.net/manual/zh/function.jdmonthname.php
 * @param int $julian_day
 * @param int $mode
 ...
 * @link https://php.net/manual/zh/function.easter-date.php
 ...
 * @link https://php.net/manual/zh/function.easter-days.php
 ...
 * @link https://php.net/manual/zh/function.unixtojd.php
 ...
 * @link https://php.net/manual/zh/function.jdtounix.php
 * @param int $julian_day <p>
 ...
 * @link https://php.net/manual/zh/function.cal-to-jd.php
 ...
 * @link https://php.net/manual/zh/function.cal-from-jd.php
 * @param int $julian_day <p>
 ...
 * @link https://php.net/manual/zh/function.cal-days-in-month.php
 * @param int $calendar <p>
 ...
 * @link https://php.net/manual/zh/function.cal-info.php
