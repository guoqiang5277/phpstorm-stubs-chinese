...
/**
 * @link https://php.net/manual/zh/ref.sqlite.php
 */
class SQLiteDatabase
{
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php.net/manual/zh/function.sqlite-open.php
    ...
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php.net/manual/zh/function.sqlite-query.php
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     * Data inside the query should be {@link https://php.net/manual/zh/function.sqlite-escape-string.php properly escaped}.
     * </p>
    ...
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php.net/manual/zh/function.sqlite-exec.php
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * {@link https://php.net/manual/zh/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration
     * option.</p>
     */
     ...
     * @link https://php.net/manual/zh/function.sqlite-array-query.php
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * @link https://php.net/manual/zh/function.sqlite-single-query.php
     * @param string $query
     ...
     * @link https://php.net/manual/zh/function.sqlite-unbuffered-query.php
     * @param string $query  <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * @link https://php.net/manual/zh/function.sqlite-last-insert-rowid.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-changes.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-create-aggregate.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-create-function.php
     * @param string $function_name <p>The name of the function used in SQL statements.</p>
     ...
     * {@link https://php.net/manual/zh/language.types.intro.php scalar type}).
     * </p></blockquote>
     ...
     * @link https://php.net/manual/zh/function.sqlite-busy-timeout.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-last-error.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-fetch-column-types.php
...
final class SQLiteResult implements Iterator, Countable
{
     ...
     * @link https://php.net/manual/zh/function.sqlite-fetch-array.php
     * @param int $result_type [optional]
     * <p>
     ...
     * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
     * it applied to the data if it was encoded using the
     * {@link https://php.net/manual/zh/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case}. You should normally leave this
     * value at its default, unless you are interoperating with databases created by
     * other sqlite capable applications.</p>
     * @return array
     * <p>
     ...
     * @link https://php.net/manual/zh/function.sqlite-fetch-object.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-fetch-single.php
     * @param bool $decode_binary [optional]
     ...
     * @link https://php.net/manual/zh/function.sqlite-column.php
     * @param $index_or_name
     ...
     * @link https://php.net/manual/zh/function.sqlite-num-fields.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-field-name.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-current.php
     * @param int $result_type [optional] <p>The optional <i>result_type</i>
     * parameter accepts a constant and determines how the returned array will be
     ...
     * @link https://php.net/manual/zh/function.sqlite-next.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-prev.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-has-prev.php
     * @return bool <p>
     ...
     * @link https://php.net/manual/zh/function.sqlite-num-rows.php
     ...
     * @link https://php.net/manual/zh/function.sqlite-seek.php
     * @param $row
     * <p>
 ...
 * @link https://php.net/manual/zh/function.sqlite-popen.php
 * @param string $filename <p>
 * The filename of the SQLite database. If the file does not exist, SQLite
 * will attempt to create it. PHP must have write permissions to the file
 * if data is inserted, the database schema is modified or to create the
 ...
 * @link https://php.net/manual/zh/function.sqlite-close.php
 ...
 * @link https://php.net/manual/zh/function.sqlite-fetch-string.php
 * @param resource $result <p>The SQLite result resource. This parameter is not required when using the object-oriented method.</p>
 * @param bool $decode_binary [optional] <p>When the <b>decode_binary</b>
 * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
 * it applied to the data if it was encoded using the
 ...
 * @link https://php.net/manual/zh/function.sqlite-fetch-all.php
 * @param int $result_type [optional]
 * @param bool $decode_binary [optional]
 ...
 * {@link https://php.net/manual/zh/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration option.</p>
 */
 ...
 * @link https://php.net/manual/zh/function.sqlite-libversion.php
 ...
 * @link https://php.net/manual/zh/function.sqlite-libencoding.php
 ...
 * @link https://php.net/manual/zh/function.sqlite-rewind.php
 * @param resource $result <p>
 * The SQLite result resource.  This parameter is not required when using
 * the object-oriented method.
 * </p>
 ...
 * @link https://php.net/manual/zh/function.sqlite-valid.php
 * @param resource $result <p>
 * The SQLite result resource.  This parameter is not required when using
 * the object-oriented method.
 * </p>
 ...
 * @link https://php.net/manual/zh/function.sqlite-has-more.php
 * @param resource $result <p>
 ...
 * @link https://php.net/manual/zh/function.sqlite-escape-string.php
 * @param string $item <p>
 ...
 * @link https://php.net/manual/zh/function.sqlite-error-string.php
 ...
 * @link https://php.net/manual/zh/function.sqlite-factory.php
 * @param string $filename <p>
 ...
 * @link https://php.net/manual/zh/function.sqlite-udf-encode-binary.php
 * @param string $data <p>
 ...
 * @link https://php.net/manual/zh/function.sqlite-udf-decode-binary.php
 * @param string $data <p>
