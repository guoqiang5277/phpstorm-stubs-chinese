...
class Judy implements ArrayAccess
{
     ...
     * @link https://php.net/manual/zh/judy.construct.php
     ...
     * @link https://php.net/manual/zh/judy.destruct.php
     */
     ...
     * @link https://php.net/manual/zh/judy.bycount.php
     ...
     * @link https://php.net/manual/zh/judy.count.php
     ...
     * @link https://php.net/manual/zh/judy.first.php
     ...
     * @link https://php.net/manual/zh/judy.firstempty.php
     * @param mixed $index [optional] <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://php.net/manual/zh/judy.free.php
     */
     ...
     * @link https://php.net/manual/zh/judy.gettype.php
     ...
     * @link https://php.net/manual/zh/judy.last.php
     ...
     * @link https://php.net/manual/zh/judy.lastempty.php
     * @param int|string $index [optional] <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://php.net/manual/zh/judy.memoryusage.php
     ...
     * @link https://php.net/manual/zh/judy.next.php
     ...
     * @link https://php.net/manual/zh/judy.nextempty.php
     ...
     * @link https://php.net/manual/zh/judy.offsetexists.php
     ...
     * @link https://php.net/manual/zh/judy.offsetget.php
     * @param mixed $offset <p>An offset to check for.</p>
     ...
     * @link https://php.net/manual/zh/judy.offsetset.php
     ...
     * (PECL judy &gt;= 0.1.1)<br/>
     * Unsets an offset.
     * @link https://php.net/manual/zh/judy.offsetunset.php
     * @param mixed $offset <p>The offset to assign the value to.</p>
     */
     ...
     * @link https://php.net/manual/zh/judy.prev.php
     * @param mixed $index <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://php.net/manual/zh/judy.prevempty.php
     * @param mixed $index <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://php.net/manual/zh/judy.size.php
     * @param int $index_start [optional] <p>Start counting from the given index. Default is first index.</p>
     * @param int $index_end [optional] <p>Stop counting when reaching this index. Default is last index.</p>
     * @return int <p>Return the number of elements.</p>
     */
