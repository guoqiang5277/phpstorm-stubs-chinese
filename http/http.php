...
/**
 * @link https://php.net/manual/zh/class.httpdeflatestream.php
 */
class HttpDeflateStream
{
     ...
     * @link https://php.net/manual/zh/function.httpdeflatestream-construct.php
     ...
     * @link https://php.net/manual/zh/function.httpdeflatestream-update.php
     * @param string $data <p>
     * data to deflate
     * </p>
     ...
     * @link https://php.net/manual/zh/function.httpdeflatestream-flush.php
     ...
     * @link https://php.net/manual/zh/function.httpdeflatestream-finish.php
     * @param string $data [optional] <p>
     * data to deflate
     * </p>
     ...
     * @link https://php.net/manual/zh/function.httpdeflatestream-factory.php
     * @param int $flags [optional] <p>
     * initialization flags
     * </p>
...
/**
 * @link https://php.net/manual/zh/class.httpinflatestream.php
 */
class HttpInflateStream
{
     ...
     * @link https://php.net/manual/zh/function.httpinflatestream-construct.php
     * @param int $flags [optional] <p>
     * initialization flags
     * </p>
     */
     ...
     * @link https://php.net/manual/zh/function.httpinflatestream-update.php
     * @param string $data <p>
     * data to inflate
     * </p>
     ...
     * @link https://php.net/manual/zh/function.httpinflatestream-flush.php
     * @param string $data [optional] <p>
     ...
     * @link https://php.net/manual/zh/function.httpinflatestream-finish.php
     * @param string $data [optional] <p>
     * data to inflate
     * </p>
     ...
     * @link https://php.net/manual/zh/function.httpinflatestream-factory.php
     * @param int $flags [optional] <p>
     * initialization flags
     * </p>
     * @param string $class_name [optional] <p>
...
/**
 * @link https://php.net/manual/zh/class.httpmessage.php
 */
class HttpMessage implements Countable, Serializable, Iterator
{
     ...
     * @link https://php.net/manual/zh/function.httpmessage-construct.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get message body
     * @link https://php.net/manual/zh/function.httpmessage-getbody.php
     ...
     * Set message body
     * @link https://php.net/manual/zh/function.httpmessage-setbody.php
     * @param string $body <p>
     ...
     * Get header
     * @link https://php.net/manual/zh/function.httpmessage-getheader.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get message headers
     * @link https://php.net/manual/zh/function.httpmessage-getheaders.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set headers
     * @link https://php.net/manual/zh/function.httpmessage-setheaders.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Add headers
     * @link https://php.net/manual/zh/function.httpmessage-addheaders.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get message type
     * @link https://php.net/manual/zh/function.httpmessage-gettype.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set message type
     * @link https://php.net/manual/zh/function.httpmessage-settype.php
     * @param int $type <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get response code
     * @link https://php.net/manual/zh/function.httpmessage-getresponsecode.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set response code
     * @link https://php.net/manual/zh/function.httpmessage-setresponsecode.php
     * @param int $code <p>
     * HTTP response code
     * </p>
     ...
     * Get response status
     * @link https://php.net/manual/zh/function.httpmessage-getresponsestatus.php
     ...
     * (PECL pecl_http &gt;= 0.23.0)<br/>
     * Set response status
     * @link https://php.net/manual/zh/function.httpmessage-setresponsestatus.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get request method
     * @link https://php.net/manual/zh/function.httpmessage-getrequestmethod.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set request method
     * @link https://php.net/manual/zh/function.httpmessage-setrequestmethod.php
     ...
     * (PECL pecl_http &gt;= 0.21.0)<br/>
     * Get request URL
     * @link https://php.net/manual/zh/function.httpmessage-getrequesturl.php
     ...
     * (PECL pecl_http &gt;= 0.21.0)<br/>
     * Set request URL
     * @link https://php.net/manual/zh/function.httpmessage-setrequesturl.php
     * @param string $url <p>
     * the request URL
     * </p>
     * @return bool TRUE on success, or FALSE if the message is not of type
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get HTTP version
     * @link https://php.net/manual/zh/function.httpmessage-gethttpversion.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set HTTP version
     * @link https://php.net/manual/zh/function.httpmessage-sethttpversion.php
     ...
     * (PECL pecl_http &gt;= 1.0.0)<br/>
     * Guess content type
     * @link https://php.net/manual/zh/function.httpmessage-guesscontenttype.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get parent message
     * @link https://php.net/manual/zh/function.httpmessage-getparentmessage.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Send message
     * @link https://php.net/manual/zh/function.httpmessage-send.php
     ...
     * @link https://php.net/manual/zh/function.httpmessage-tostring.php
     ...
     * @link https://php.net/manual/zh/function.httpmessage-tomessagetypeobject.php
     ...
     * @link https://php.net/manual/zh/function.httpmessage-factory.php
     ...
     * Create HttpMessage from string
     * @link https://php.net/manual/zh/function.httpmessage-fromstring.php
     * @param string $raw_message [optional] <p>
     * a single or several consecutive HTTP messages
     * </p>
     * @param string $class_name [optional] <p>
     ...
     * @link https://php.net/manual/zh/function.httpmessage-fromenv.php
     ...
     * (PECL pecl_http &gt;= 0.22.0)<br/>
     * Detach HttpMessage
     * @link https://php.net/manual/zh/function.httpmessage-detach.php
     ...
     * (PECL pecl_http &gt;= 0.22.0)<br/>
     * Prepend message(s)
     * @link https://php.net/manual/zh/function.httpmessage-prepend.php
     ...
     * @link https://php.net/manual/zh/function.httpmessage-reverse.php
...
/**
 * @link https://php.net/manual/zh/class.httpquerystring.php
 */
class HttpQueryString implements Serializable, ArrayAccess
{
     ...
     * @link https://php.net/manual/zh/function.httpquerystring-construct.php
     ...
     * @link https://php.net/manual/zh/function.httpquerystring-toarray.php
     ...
     * (PECL pecl_http &gt;= 0.22.0)<br/>
     * Get query string
     * @link https://php.net/manual/zh/function.httpquerystring-tostring.php
     ...
     * @link https://php.net/manual/zh/function.httpquerystring-get.php
     ...
     * @link https://php.net/manual/zh/function.httpquerystring-set.php
     ...
     * @link https://php.net/manual/zh/function.httpquerystring-mod.php
     * @param mixed $params <p>
     * query string params to add
     * </p>
     ...
     * @link https://php.net/manual/zh/function.httpquerystring-singleton.php
     * @param bool $global [optional] <p>
     * whether to operate on $_GET and
     * $_SERVER['QUERY_STRING']
     * </p>
     ...
     * @link https://php.net/manual/zh/function.httpquerystring-xlate.php
     * @param string $ie <p>
     * input encoding
     * </p>
     * @param string $oe <p>
...
/**
 * @link https://php.net/manual/zh/class.httprequest.php
 */
class HttpRequest
{
     ...
     * @link https://php.net/manual/zh/function.httprequest-construct.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set options
     * @link https://php.net/manual/zh/function.httprequest-setoptions.php
     * @param null|array $options [optional] <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get options
     * @link https://php.net/manual/zh/function.httprequest-getoptions.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set ssl options
     * @link https://php.net/manual/zh/function.httprequest-setssloptions.php
     * @param null|array $options [optional] <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get ssl options
     * @link https://php.net/manual/zh/function.httprequest-getssloptions.php
     ...
     * Add ssl options
     * @link https://php.net/manual/zh/function.httprequest-addssloptions.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Add headers
     * @link https://php.net/manual/zh/function.httprequest-addheaders.php
     * @param array $headers <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get headers
     * @link https://php.net/manual/zh/function.httprequest-getheaders.php
     ...
     * (PECL pecl_http &gt;= 0.12.0)<br/>
     * Set headers
     * @link https://php.net/manual/zh/function.httprequest-setheaders.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Add cookies
     * @link https://php.net/manual/zh/function.httprequest-addcookies.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get cookies
     * @link https://php.net/manual/zh/function.httprequest-getcookies.php
     ...
     * (PECL pecl_http &gt;= 0.12.0)<br/>
     * Set cookies
     * @link https://php.net/manual/zh/function.httprequest-setcookies.php
     ...
     * (PECL pecl_http &gt;= 1.0.0)<br/>
     * Enable cookies
     * @link https://php.net/manual/zh/function.httprequest-enablecookies.php
     * @return bool true on success or false on failure.
     */
     ...
     * (PECL pecl_http &gt;= 1.0.0)<br/>
     * Reset cookies
     * @link https://php.net/manual/zh/function.httprequest-resetcookies.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set method
     * @link https://php.net/manual/zh/function.httprequest-setmethod.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get method
     * @link https://php.net/manual/zh/function.httprequest-getmethod.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set URL
     * @link https://php.net/manual/zh/function.httprequest-seturl.php
     * @param string $url <p>
     * the request url
     * </p>
     * @return bool true on success or false on failure.
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get url
     * @link https://php.net/manual/zh/function.httprequest-geturl.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set content type
     * @link https://php.net/manual/zh/function.httprequest-setcontenttype.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get content type
     * @link https://php.net/manual/zh/function.httprequest-getcontenttype.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set query data
     * @link https://php.net/manual/zh/function.httprequest-setquerydata.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get query data
     * @link https://php.net/manual/zh/function.httprequest-getquerydata.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Add query data
     * @link https://php.net/manual/zh/function.httprequest-addquerydata.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set post fields
     * @link https://php.net/manual/zh/function.httprequest-setpostfields.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get post fields
     * @link https://php.net/manual/zh/function.httprequest-getpostfields.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Add post fields
     * @link https://php.net/manual/zh/function.httprequest-addpostfields.php
     * @param array $post_data <p>
     ...
     * Set raw post data
     * @link https://php.net/manual/zh/function.httprequest-setrawpostdata.php
     ...
     * (PECL pecl_http 0.14.0-1.4.1)<br/>
     * Get raw post data
     * @link https://php.net/manual/zh/function.httprequest-getrawpostdata.php
     ...
     * (PECL pecl_http 0.14.0-1.4.1)<br/>
     * Add raw post data
     * @link https://php.net/manual/zh/function.httprequest-addrawpostdata.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set post files
     * @link https://php.net/manual/zh/function.httprequest-setpostfiles.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Add post file
     * @link https://php.net/manual/zh/function.httprequest-addpostfile.php
     * @param string $name <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get post files
     * @link https://php.net/manual/zh/function.httprequest-getpostfiles.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set put file
     * @link https://php.net/manual/zh/function.httprequest-setputfile.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get put file
     * @link https://php.net/manual/zh/function.httprequest-getputfile.php
     ...
     * (PECL pecl_http &gt;= 0.25.0)<br/>
     * Set put data
     * @link https://php.net/manual/zh/function.httprequest-setputdata.php
     ...
     * (PECL pecl_http &gt;= 0.25.0)<br/>
     * Get put data
     * @link https://php.net/manual/zh/function.httprequest-getputdata.php
     ...
     * (PECL pecl_http &gt;= 0.25.0)<br/>
     * Add put data
     * @link https://php.net/manual/zh/function.httprequest-addputdata.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Send request
     * @link https://php.net/manual/zh/function.httprequest-send.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get response data
     * @link https://php.net/manual/zh/function.httprequest-getresponsedata.php
     ...
     * @link https://php.net/manual/zh/function.httprequest-getresponseheader.php
     ...
     * @link https://php.net/manual/zh/function.httprequest-getresponsecookies.php
     * @param int $flags [optional] <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get response code
     * @link https://php.net/manual/zh/function.httprequest-getresponsecode.php
     ...
     * (PECL pecl_http &gt;= 0.23.0)<br/>
     * Get response status
     * @link https://php.net/manual/zh/function.httprequest-getresponsestatus.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get response body
     * @link https://php.net/manual/zh/function.httprequest-getresponsebody.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get response info
     * @link https://php.net/manual/zh/function.httprequest-getresponseinfo.php
     * @param string $name [optional] <p>
     ...
     * @link https://php.net/manual/zh/function.httprequest-getresponsemessage.php
     ...
     * @link https://php.net/manual/zh/function.httprequest-getrawresponsemessage.php
     ...
     * Get request message
     * @link https://php.net/manual/zh/function.httprequest-getrequestmessage.php
     ...
     * @link https://php.net/manual/zh/function.httprequest-getrawrequestmessage.php
     ...
     * Get history
     * @link https://php.net/manual/zh/function.httprequest-gethistory.php
     ...
     * (PECL pecl_http &gt;= 0.15.0)<br/>
     * Clear history
     * @link https://php.net/manual/zh/function.httprequest-clearhistory.php
     * @return void
     */
...
/**
 * @link https://php.net/manual/zh/class.httprequestpool.php
 */
class HttpRequestPool implements Countable, Iterator
{
     ...
     * @link https://php.net/manual/zh/function.httprequestpool-construct.php
     ...
     * @link https://php.net/manual/zh/function.httprequestpool-destruct.php
     * @return void
     */
    public function __destruct() {}
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Attach HttpRequest
     * @link https://php.net/manual/zh/function.httprequestpool-attach.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Detach HttpRequest
     * @link https://php.net/manual/zh/function.httprequestpool-detach.php
     * @param HttpRequest $request <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Send all requests
     * @link https://php.net/manual/zh/function.httprequestpool-send.php
     * @return bool true on success or false on failure.
     */
    public function send() {}
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Reset request pool
     * @link https://php.net/manual/zh/function.httprequestpool-reset.php
     * @return void
     */
    public function reset() {}
     ...
     * @link https://php.net/manual/zh/function.httprequestpool-socketperform.php
     ...
     * @link https://php.net/manual/zh/function.httprequestpool-socketselect.php
     * @return bool true on success or false on failure.
     */
     ...
     * @link https://php.net/manual/zh/function.httprequestpool-getattachedrequests.php
     ...
     * @link https://php.net/manual/zh/function.httprequestpool-getfinishedrequests.php
...
/**
 * @link https://php.net/manual/zh/class.httpresponse.php
 */
class HttpResponse
{
     ...
     * (PECL pecl_http &gt;= 0.12.0)<br/>
     * Set header
     * @link https://php.net/manual/zh/function.httpresponse-setheader.php
     * @param string $name <p>
     ...
     * (PECL pecl_http &gt;= 0.12.0)<br/>
     * Get header
     * @link https://php.net/manual/zh/function.httpresponse-getheader.php
     * @param string $name [optional] <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set ETag
     * @link https://php.net/manual/zh/function.httpresponse-setetag.php
     * @param string $etag <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get ETag
     * @link https://php.net/manual/zh/function.httpresponse-getetag.php
     ...
     * (PECL pecl_http &gt;= 0.12.0)<br/>
     * Set last modified
     * @link https://php.net/manual/zh/function.httpresponse-setlastmodified.php
     ...
     * (PECL pecl_http &gt;= 0.12.0)<br/>
     * Get last modified
     * @link https://php.net/manual/zh/function.httpresponse-getlastmodified.php
     ...
     * @link https://php.net/manual/zh/function.httpresponse-setcontentdisposition.php
     ...
     * @link https://php.net/manual/zh/function.httpresponse-getcontentdisposition.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set content type
     * @link https://php.net/manual/zh/function.httpresponse-setcontenttype.php
     * @param string $content_type <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get content type
     * @link https://php.net/manual/zh/function.httpresponse-getcontenttype.php
     ...
     * Guess content type
     * @link https://php.net/manual/zh/function.httpresponse-guesscontenttype.php
     * @param string $magic_file <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set cache
     * @link https://php.net/manual/zh/function.httpresponse-setcache.php
     * @param bool $cache <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get cache
     * @link https://php.net/manual/zh/function.httpresponse-getcache.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set cache control
     * @link https://php.net/manual/zh/function.httpresponse-setcachecontrol.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get cache control
     * @link https://php.net/manual/zh/function.httpresponse-getcachecontrol.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set gzip
     * @link https://php.net/manual/zh/function.httpresponse-setgzip.php
     * @param bool $gzip <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get gzip
     * @link https://php.net/manual/zh/function.httpresponse-getgzip.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set throttle delay
     * @link https://php.net/manual/zh/function.httpresponse-setthrottledelay.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get throttle delay
     * @link https://php.net/manual/zh/function.httpresponse-getthrottledelay.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set buffer size
     * @link https://php.net/manual/zh/function.httpresponse-setbuffersize.php
     * @param int $bytes <p>
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get buffer size
     * @link https://php.net/manual/zh/function.httpresponse-getbuffersize.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set data
     * @link https://php.net/manual/zh/function.httpresponse-setdata.php
     * @param mixed $data <p>
     * data to send
     * </p>
     * @return bool true on success or false on failure.
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get data
     * @link https://php.net/manual/zh/function.httpresponse-getdata.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set file
     * @link https://php.net/manual/zh/function.httpresponse-setfile.php
     * @param string $file <p>
     * the path to the file to send
     * </p>
     * @return bool true on success or false on failure.
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get file
     * @link https://php.net/manual/zh/function.httpresponse-getfile.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Set stream
     * @link https://php.net/manual/zh/function.httpresponse-setstream.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get Stream
     * @link https://php.net/manual/zh/function.httpresponse-getstream.php
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Send response
     * @link https://php.net/manual/zh/function.httpresponse-send.php
     ...
     * @link https://php.net/manual/zh/function.httpresponse-capture.php
     * @return void
     */
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Redirect
     * @link https://php.net/manual/zh/function.httpresponse-redirect.php
     ...
     * @link https://php.net/manual/zh/function.httpresponse-status.php
     * @param int $status
     * @return bool
     */
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get request headers
     * @link https://php.net/manual/zh/function.httpresponse-getrequestheaders.php
     * @return array
     */
     ...
     * (PECL pecl_http &gt;= 0.10.0)<br/>
     * Get request body
     * @link https://php.net/manual/zh/function.httpresponse-getrequestbody.php
     * @return string
     */
     ...
     * @link https://php.net/manual/zh/function.httpresponse-getrequestbodystream.php
     * @return resource
     */
 ...
 * @link https://php.net/manual/zh/function.http-date.php
 ...
 * (PECL pecl_http &gt;= 0.21.0)<br/>
 * Build an URL
 * @link https://php.net/manual/zh/function.http-build-url.php
 ...
 * (PECL pecl_http &gt;= 0.23.0)<br/>
 * Build query string
 * @link https://php.net/manual/zh/function.http-build-str.php
 * @param array $query <p>
 ...
 * @link https://php.net/manual/zh/function.http-negotiate-language.php
 ...
 * @link https://php.net/manual/zh/function.http-negotiate-charset.php
 * @param array $supported <p>
 ...
 * @link https://php.net/manual/zh/function.http-negotiate-content-type.php
 * @param array $supported <p>
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Issue HTTP redirect
 * @link https://php.net/manual/zh/function.http-redirect.php
 * @param string $url [optional] <p>
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * HTTP throttling
 * @link https://php.net/manual/zh/function.http-throttle.php
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send HTTP response status
 * @link https://php.net/manual/zh/function.http-send-status.php
 * @param int $status <p>
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send Last-Modified
 * @link https://php.net/manual/zh/function.http-send-last-modified.php
 * @param int $timestamp [optional] <p>
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * Send Content-Type
 * @link https://php.net/manual/zh/function.http-send-content-type.php
 * @param string $content_type [optional] <p>
 ...
 * @link https://php.net/manual/zh/function.http-send-content-disposition.php
 * @param string $filename <p>
 * the file name the &quot;Save as...&quot; dialog should display
 * </p>
 * @param bool $inline [optional] <p>
 ...
 * @link https://php.net/manual/zh/function.http-match-modified.php
 * @param int $timestamp [optional] <p>
 * Unix timestamp; current time, if omitted
 * </p>
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Match ETag
 * @link https://php.net/manual/zh/function.http-match-etag.php
 * @param string $etag <p>
 * the ETag to match
 * </p>
 * @param bool $for_range [optional] <p>
 ...
 * @link https://php.net/manual/zh/function.http-cache-last-modified.php
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Caching by ETag
 * @link https://php.net/manual/zh/function.http-cache-etag.php
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send arbitrary data
 * @link https://php.net/manual/zh/function.http-send-data.php
 * @param string $data <p>
 * data to send
 * </p>
 * @return bool true on success or false on failure.
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send file
 * @link https://php.net/manual/zh/function.http-send-file.php
 * @param string $file <p>
 * the file to send
 * </p>
 * @return bool true on success or false on failure.
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send stream
 * @link https://php.net/manual/zh/function.http-send-stream.php
 * @param resource $stream <p>
 ...
 * @link https://php.net/manual/zh/function.http-chunked-decode.php
 ...
 * (PECL pecl_http &gt;= 0.12.0)<br/>
 * Parse HTTP messages
 * @link https://php.net/manual/zh/function.http-parse-message.php
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * Parse HTTP headers
 * @link https://php.net/manual/zh/function.http-parse-headers.php
 * @param string $header <p>
 ...
 * Parse HTTP cookie
 * @link https://php.net/manual/zh/function.http-parse-cookie.php
 ...
 * Build cookie string
 * @link https://php.net/manual/zh/function.http-build-cookie.php
 ...
 * @link https://php.net/manual/zh/function.http-parse-params.php
 ...
 * @link https://php.net/manual/zh/function.http-get-request-headers.php
 ...
 * @link https://php.net/manual/zh/function.http-get-request-body.php
 ...
 * @link https://php.net/manual/zh/function.http-get-request-body-stream.php
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * Match any header
 * @link https://php.net/manual/zh/function.http-match-request-header.php
 * @param string $header <p>
 ...
 * @link https://php.net/manual/zh/function.http-persistent-handles-count.php
 ...
 * @link https://php.net/manual/zh/function.http-persistent-handles-clean.php
 ...
 * @link https://php.net/manual/zh/function.http-persistent-handles-ident.php
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Perform GET request
 * @link https://php.net/manual/zh/function.http-get.php
 * @param string $url <p>
 * URL
 * </p>
 * @param null|array $options [optional] <p>
 ...
 * @link https://php.net/manual/zh/function.http-head.php
 * @param string $url [optional] <p>
 * URL
 * </p>
 * @param null|array $options [optional] <p>
 ...
 * @link https://php.net/manual/zh/function.http-post-data.php
 * @param string $url <p>
 * URL
 * </p>
 * @param string $data [optional] <p>
 ...
 * @link https://php.net/manual/zh/function.http-post-fields.php
 * @param string $url <p>
 * URL
 * </p>
 ...
 * @link https://php.net/manual/zh/function.http-put-data.php
 * @param string $url <p>
 * URL
 * </p>
 ...
 * @link https://php.net/manual/zh/function.http-put-file.php
 * @param string $url <p>
 * URL
 * </p>
 ...
 * @link https://php.net/manual/zh/function.http-put-stream.php
 * @param string $url <p>
 * URL
 * </p>
 ...
 * @link https://php.net/manual/zh/function.http-request.php
 * @param int $method <p>
 * Request method
 * </p>
 ...
 * (PECL pecl_http &gt;= 1.0.0)<br/>
 * Encode request body
 * @link https://php.net/manual/zh/function.http-request-body-encode.php
 ...
 * @link https://php.net/manual/zh/function.http-request-method-register.php
 * @param string $method <p>
 ...
 * @link https://php.net/manual/zh/function.http-request-method-unregister.php
 ...
 * @link https://php.net/manual/zh/function.http-request-method-exists.php
 * @param mixed $method <p>
 ...
 * @link https://php.net/manual/zh/function.http-request-method-name.php
 * @param int $method <p>
 * request method ID
 * </p>
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * ETag output handler
 * @link https://php.net/manual/zh/function.ob-etaghandler.php
 * @param string $data
 * @param int $mode
 * @return string
 */
 ...
 * (PECL pecl_http &gt;= 0.15.0)<br/>
 * Deflate data
 * @link https://php.net/manual/zh/function.http-deflate.php
 * @param string $data <p>
 ...
 * (PECL pecl_http &gt;= 0.15.0)<br/>
 * Inflate data
 * @link https://php.net/manual/zh/function.http-inflate.php
 * @param string $data <p>
 ...
 * @link https://php.net/manual/zh/function.ob-deflatehandler.php
 * @param string $data
 * @param int $mode
 * @return string
 */
 ...
 * @link https://php.net/manual/zh/function.ob-inflatehandler.php
 * @param string $data
 * @param int $mode
 * @return string
 */
 ...
 * @link https://php.net/manual/zh/function.http-support.php
 ...
 * @link https://php.net/manual/zh/http.constants.php
 */
