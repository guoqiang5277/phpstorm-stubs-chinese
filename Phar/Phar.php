 ...
 * @link https://php.net/manual/zh/class.pharexception.php
 */
 ...
 * phar archives.
 * @link https://php.net/manual/zh/class.phar.php
 */
class Phar extends RecursiveDirectoryIterator implements RecursiveIterator, SeekableIterator, Countable, ArrayAccess
{
     ...
     * @link https://php.net/manual/zh/phar.construct.php
     ...
     * @link https://php.net/manual/zh/phar.addemptydir.php
     ...
     * @link https://php.net/manual/zh/phar.addfile.php
     * @param string $filename <p>
     ...
     * (Unknown)<br/>
     * Add a file from the filesystem to the phar archive
     * @link https://php.net/manual/zh/phar.addfromstring.php
     ...
     * @link https://php.net/manual/zh/phar.buildfromdirectory.php
     * @param string $directory <p>
     ...
     * @link https://php.net/manual/zh/phar.buildfromiterator.php
     ...
     * @link https://php.net/manual/zh/phar.compressfiles.php
     ...
     * @link https://php.net/manual/zh/phar.decompressfiles.php
     ...
     * @link https://php.net/manual/zh/phar.compress.php
     * @param int $compression <p>
     * Compression must be one of Phar::GZ,
     * Phar::BZ2 to add compression, or Phar::NONE
     * to remove compression.
     ...
     * @link https://php.net/manual/zh/phar.decompress.php
     * @param string $extension [optional] <p>
     ...
     * @link https://php.net/manual/zh/phar.converttoexecutable.php
     ...
     * @link https://php.net/manual/zh/phar.converttodata.php
     * @param int $format [optional] <p>
     ...
     * @link https://php.net/manual/zh/phar.copy.php
     * @param string $to
     * @param string $from
     ...
     * @link https://php.net/manual/zh/phar.count.php
     ...
     * @link https://php.net/manual/zh/phar.delete.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/zh/phar.delmetadata.php
     * @return bool returns <b>TRUE</b> on success, but it is better to check for thrown exception,
     * and assume success if none is thrown.
     */
     ...
     * @link https://php.net/manual/zh/phar.extractto.php
     * @param string $directory <p>
     * Path within an archive to the file to delete.
     * </p>
     ...
     * @link https://php.net/manual/zh/phar.getmetadata.php
     ...
     * @link https://php.net/manual/zh/phar.getmodified.php
     ...
     * @link https://php.net/manual/zh/phar.getsignature.php
     ...
     * @link https://php.net/manual/zh/phar.getstub.php
     ...
     * @link https://php.net/manual/zh/phar.getversion.php
     ...
     * @link https://php.net/manual/zh/phar.hasmetadata.php
     ...
     * @link https://php.net/manual/zh/phar.isbuffering.php
     ...
     * @link https://php.net/manual/zh/phar.iscompressed.php
     ...
     * @link https://php.net/manual/zh/phar.isfileformat.php
     * @param int $format <p>
     ...
     * @link https://php.net/manual/zh/phar.iswritable.php
     ...
     * @link https://php.net/manual/zh/phar.offsetexists.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/zh/phar.offsetget.php
     * @param string $localName <p>
     * The filename (relative path) to look for in a Phar.
     * </p>
     ...
     * @link https://php.net/manual/zh/phar.offsetset.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/zh/phar.offsetunset.php
     * @param string $localName <p>
     * The filename (relative path) to modify in a Phar.
     * </p>
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     ...
     * @link https://php.net/manual/zh/phar.setalias.php
     ...
     * @link https://php.net/manual/zh/phar.setdefaultstub.php
     ...
     * @link https://php.net/manual/zh/phar.setmetadata.php
     ...
     * @link https://php.net/manual/zh/phar.setsignaturealgorithm.php
     * @param int $algo <p>
     * One of Phar::MD5,
     ...
     * @link https://php.net/manual/zh/phar.setstub.php
     * @param string $stub <p>
     ...
     * @link https://php.net/manual/zh/phar.startbuffering.php
     * @return void No value is returned.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/phar.stopbuffering.php
     * @return void No value is returned.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/phar.apiversion.php
     ...
     * @link https://php.net/manual/zh/phar.cancompress.php
     * @param int $compression [optional] <p>
     ...
     * @link https://php.net/manual/zh/phar.canwrite.php
     ...
     * @link https://php.net/manual/zh/phar.createdefaultstub.php
     ...
     * @link https://php.net/manual/zh/phar.getsupportedcompression.php
     ...
     * @link https://php.net/manual/zh/phar.getsupportedsignatures.php
     ...
     * @link https://php.net/manual/zh/phar.interceptfilefuncs.php
     * @return void
     */
     ...
     * @link https://php.net/manual/zh/phar.isvalidpharfilename.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/zh/phar.loadphar.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/zh/phar.mapphar.php
     * @param string|null $alias [optional] <p>
     ...
     * @link https://php.net/manual/zh/phar.running.php
     ...
     * @link https://php.net/manual/zh/phar.mount.php
     ...
     * @link https://php.net/manual/zh/phar.mungserver.php
     ...
     * @link https://php.net/manual/zh/phar.unlinkarchive.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/zh/phar.webphar.php
 ...
 * @link https://php.net/manual/zh/class.phardata.php
 */
class PharData extends Phar
{
     ...
     * @link https://php.net/manual/zh/phardata.construct.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/zh/phardata.offsetset.php
     * @param string $localName <p>
     ...
     * @link https://php.net/manual/zh/phardata.offsetunset.php
     * @param string $localName <p>
 ...
 * @link https://php.net/manual/zh/class.pharfileinfo.php
 */
class PharFileInfo extends SplFileInfo
{
     ...
     * @link https://php.net/manual/zh/pharfileinfo.construct.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/zh/pharfileinfo.chmod.php
     * @param int $perms <p>
     ...
     * @link https://php.net/manual/zh/pharfileinfo.compress.php
     ...
     * @link https://php.net/manual/zh/pharfileinfo.decompress.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/zh/pharfileinfo.delmetadata.php
     ...
     * @link https://php.net/manual/zh/pharfileinfo.getcompressedsize.php
     ...
     * @link https://php.net/manual/zh/pharfileinfo.getcrc32.php
     ...
     * @link https://php.net/manual/zh/pharfileinfo.getmetadata.php
     * @param array $unserializeOptions [optional] if is set to anything other than the default,
     * the resulting metadata won't be cached and this won't return the value from the cache
     ...
     * @link https://php.net/manual/zh/pharfileinfo.getpharflags.php
     ...
     * @link https://php.net/manual/zh/pharfileinfo.hasmetadata.php
     ...
     * @link https://php.net/manual/zh/pharfileinfo.iscompressed.php
     * @param int $compression [optional] <p>
     ...
     * @link https://php.net/manual/zh/pharfileinfo.iscrcchecked.php
     ...
     * @link https://php.net/manual/zh/pharfileinfo.setmetadata.php
     * @param mixed $metadata <p>
