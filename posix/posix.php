...
/**
 * Get system name
 * @link https://php.net/manual/zh/function.posix-uname.php
...
/**
 * Get process times
 * @link https://php.net/manual/zh/function.posix-times.php
 ...
 * @link https://php.net/manual/zh/function.posix-getpwnam.php
 ...
 * @link https://php.net/manual/zh/function.posix-getpwuid.php
 * @param int $user_id <p>
 * The user identifier.
 * </p>
 ...
 * @link https://php.net/manual/zh/posix.constants.php
 */
define('POSIX_F_OK', 0);
 ...
 * @link https://php.net/manual/zh/posix.constants.setrlimit.php
 */
...
/**
 * The maximum value to which the process can be <a href="https://php.net/manual/zh/function.pcntl-setpriority.php"> reniced</a> to. The value that will be used will be 20 - limit, as resource limit values cannot be negative.
 * @link https://php.net/manual/zh/posix.constants.setrlimit.php
 */
