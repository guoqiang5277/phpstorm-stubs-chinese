 ...
 * @link https://php.net/manual/zh/class.simplexmlelement.php
 */
class SimpleXMLElement implements Traversable, ArrayAccess, Countable, Iterator, Stringable, RecursiveIterator
{
    /**
     * Creates a new SimpleXMLElement object
     * @link https://php.net/manual/zh/simplexmlelement.construct.php
     ...
     * @link https://php.net/manual/zh/simplexmlelement.asxml.php
     ...
     * Return a well-formed XML string based on SimpleXML element
     * @link https://php.net/manual/zh/simplexmlelement.savexml.php
     * @param string $filename [optional] <p>
     * If specified, the function writes the data to the file rather than
     * returning it.
     * </p>
     ...
     * @link https://php.net/manual/zh/simplexmlelement.xpath.php
     ...
     * @link https://php.net/manual/zh/simplexmlelement.registerxpathnamespace.php
     ...
     * @link https://php.net/manual/zh/simplexmlelement.attributes.php
     ...
     * @link https://php.net/manual/zh/simplexmlelement.children.php
     * @param string $namespaceOrPrefix [optional] <p>
     * An XML namespace.
     * </p>
     * @param bool $isPrefix [optional] <p>
     ...
     * @link https://php.net/manual/zh/simplexmlelement.getnamespaces.php
     ...
     * @link https://php.net/manual/zh/simplexmlelement.getdocnamespaces.php
     * @param bool $recursive [optional] <p>
     ...
     * @link https://php.net/manual/zh/simplexmlelement.getname.php
     ...
     * @link https://php.net/manual/zh/simplexmlelement.addchild.php
     ...
     * @link https://php.net/manual/zh/simplexmlelement.addattribute.php
     * @param string $qualifiedName <p>
     ...
     * @link https://php.net/manual/zh/simplexmlelement.tostring.php
     ...
     * @link https://php.net/manual/zh/simplexmlelement.count.php
     ...
     * @link https://php.net/manual/zh/simplexmliterator.rewind.php
     * @return void No value is returned.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/simplexmliterator.valid.php
     ...
     * @link https://php.net/manual/zh/simplexmliterator.current.php
    ...
    /**
     * Return current key
     * @link https://php.net/manual/zh/simplexmliterator.key.php
     ...
     * @link https://php.net/manual/zh/simplexmliterator.next.php
     * @return void No value is returned.
     */
    #[TentativeType]
 ...
 * @link https://php.net/manual/zh/class.simplexmliterator.php
 */
class SimpleXMLIterator extends SimpleXMLElement implements RecursiveIterator, Countable, Stringable
{
     ...
     * @link https://php.net/manual/zh/simplexmliterator.haschildren.php
     ...
     * @link https://php.net/manual/zh/simplexmliterator.getchildren.php
