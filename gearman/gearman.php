<?php
/**
 * @link https://php.net/manual/zh/gearman.constants.php
 */
...
class GearmanClient
{
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.construct.php
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.returncode.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.error.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.geterrno.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setoptions.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.addoptions.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.removeoptions.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.timeout.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.settimeout.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.context.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setcontext.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.addserver.php
     * @param string $host
     * @param int $port
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.addservers.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.dohigh.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     ...
     * priority tasks in the job queue.
     *
     * @link https://php.net/manual/zh/gearmanclient.dolow.php
     * @param string $function_name
     * @param string $workload
     * @param string $unique
     * @return string A string representing the results of running a task
     ...
     * the task.
     *
     * @link https://php.net/manual/zh/gearmanclient.dojobhandle.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.dostatus.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.dobackground.php
     * @param string $function
     * @param string $workload
     * @param string|null $unique
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.dohighbackground.php
     * @param string $function
     * @param string $workload
     * @param string|null $unique
     * @return string The job handle for the submitted task
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.dolowbackground.php
     * @param string $function
     * @param string $workload
     * @param string|null $unique
     * @return string The job handle for the submitted task
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.jobstatus.php
     ...
     * parallel.
     *
     * @link https://php.net/manual/zh/gearmanclient.addtask.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.addtaskhigh.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.addtasklow.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     * perform the work.
     *
     * @link https://php.net/manual/zh/gearmanclient.addtaskbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     * selected from the queue before those of normal or low priority.
     *
     * @link https://php.net/manual/zh/gearmanclient.addtaskhighbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.addtasklowbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string $unique
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.addtaskstatus.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setworkloadcallback.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setcreatedcallback.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setdatacallback.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setwarningcallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setstatuscallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setcompletecallback.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setexceptioncallback.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.setfailcallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.clearcallbacks.php
     * @return bool Always returns true
     */
     ...
     * parallel.
     *
     * @link https://php.net/manual/zh/gearmanclient.runtasks.php
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanclient.ping.php
     * @param string $workload
     * @return bool
     */
...
class GearmanTask
{
     ...
     *
     * @link https://php.net/manual/zh/gearmantask.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     *
     * @link https://php.net/manual/zh/gearmantask.functionname.php
     ...
     * server.
     *
     * @link https://php.net/manual/zh/gearmantask.unique.php
     ...
     *
     * @link https://php.net/manual/zh/gearmantask.jobhandle.php
     ...
     * server.
     *
     * @link https://php.net/manual/zh/gearmantask.isknown.php
     ...
     *
     * @link https://php.net/manual/zh/gearmantask.isrunning.php
     ...
     * as a fraction.
     *
     * @link https://php.net/manual/zh/gearmantask.tasknumerator.php
     ...
     * as a fraction.
     *
     * @link https://php.net/manual/zh/gearmantask.taskdenominator.php
     * @return int|false A number between 0 and 100, or false if cannot be determined
     */
     ...
     * .
     *
     * @link https://php.net/manual/zh/gearmantask.sendworkload.php
     ...
     *
     * @link https://php.net/manual/zh/gearmantask.data.php
     ...
     *
     * @link https://php.net/manual/zh/gearmantask.datasize.php
     ...
     * .
     *
     * @link https://php.net/manual/zh/gearmantask.recvdata.php
...
class GearmanWorker
{
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.construct.php
     */
    public function __construct() {}
     ...
     * Returns the last Gearman return code.
     *
     * @link https://php.net/manual/zh/gearmanworker.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     * Returns an error string for the last error encountered.
     *
     * @link https://php.net/manual/zh/gearmanworker.error.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.geterrno.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.options.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.setoptions.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.addoptions.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.removeoptions.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.timeout.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.settimeout.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.setid.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.addserver.php
     * @param string $host
     * @param int $port
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.addservers.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.wait.php
     * @return bool
     */
    public function wait() {}
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.register.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.unregister.php
     * @param string $function_name The name of a function to register with the job
     *        server
     * @return bool A standard Gearman return value
     */
     ...
     * sent to this worker.
     *
     * @link https://php.net/manual/zh/gearmanworker.unregisterall.php
     * @return bool A standard Gearman return value
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.addfunction.php
     * @param string $function_name The name of a function to register with the job
     *        server
     ...
     *
     * @link https://php.net/manual/zh/gearmanworker.work.php
     * @return bool
     */
...
class GearmanJob
{
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.setreturn.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.senddata.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.sendwarning.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.sendstatus.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.sendcomplete.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.sendexception.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.sendfail.php
     * @return bool
     */
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.handle.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.functionname.php
     ...
     * client.
     *
     * @link https://php.net/manual/zh/gearmanjob.unique.php
     ...
     *
     * @link https://php.net/manual/zh/gearmanjob.workload.php
     ...
     * bytes.
     *
     * @link https://php.net/manual/zh/gearmanjob.workloadsize.php
