 ...
 * @link https://php.net/manual/zh/class.com.php
 */
class COM
{
    /**
 ...
 * @link https://php.net/manual/zh/class.dotnet.php
 */
class DOTNET
{
    /**
 ...
 * @link https://php.net/manual/zh/class.variant.php
 */
class VARIANT
{
    /**
 ...
 * @link https://php.net/manual/zh/com.error-handling.php
 */
 ...
 * @link https://php.net/manual/zh/function.com-create-guid.php
 * @return string
 */
 ...
 * @link https://php.net/manual/zh/function.com-event-sink.php
 ...
 * @link https://php.net/manual/zh/function.com-get-active-object.php
 * @param string $progid
 ...
 * @link https://php.net/manual/zh/function.com-message-pump.php
 ...
 * @link https://php.net/manual/zh/function.com-print-typeinfo.php
 ...
 * @link https://php.net/manual/zh/function.variant-abs.php
 * @param mixed $val
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-and.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-cast.php
 ...
 * @link https://php.net/manual/zh/function.variant-cat.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-cmp.php
 * @param mixed $left
 * @param mixed $right
 ...
 * @link https://php.net/manual/zh/function.variant-date-from-timestamp.php
 * @param int $timestamp
 * @return \VARIANT
 */
 ...
 * @link https://php.net/manual/zh/function.variant-date-to-timestamp.php
 * @param \VARIANT $variant
 * @return int
 */
 ...
 * @link https://php.net/manual/zh/function.variant-div.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-eqv.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-fix.php
 * @param mixed $variant
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-get-type.php
 * @param VARIANT $variant
 * @return int
 */
 ...
 * @link https://php.net/manual/zh/function.variant-idiv.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-imp.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * (PHP 5, PHP 7)<br/>
 * Returns the integer portion of a variant
 * @link https://php.net/manual/zh/function.variant-int.php
 * @param mixed $variant
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-mod.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-mul.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-neg.php
 * @param mixed $variant
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-not.php
 * @param mixed $variant
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-or.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-pow.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-round.php
 * @param mixed $variant
 * @param int $decimals
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-set-type.php
 * @param VARIANT $variant
 * @param int $type
 * @return void
 */
 ...
 * @link https://php.net/manual/zh/function.variant-set.php
 * @param VARIANT $variant
 * @param mixed $value
 * @return void
 */
 ...
 * @link https://php.net/manual/zh/function.variant-sub.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://php.net/manual/zh/function.variant-xor.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
