 ...
 * @link https://php.net/manual/zh/function.mcrypt-ecb.php
 ...
 * @link https://php.net/manual/zh/function.mcrypt-cbc.php
 ...
 * @link https://php.net/manual/zh/function.mcrypt-cfb.php
 * @param int|string $cipher
 * @param string $key
 * @param string $data
 * @param int $mode
 ...
 * @link https://php.net/manual/zh/function.mcrypt-ofb.php
 * @param int|string $cipher
 * @param string $key
 * @param string $data
 * @param int $mode
 ...
 * @link https://php.net/manual/zh/function.mcrypt-generic-end.php
 * @param resource $td
 * @return bool
 * @removed 7.0
 */
