 ...
 * @link https://php.net/manual/zh/class.splfileinfo.php
 */
class SplFileInfo implements Stringable
{
    /**
     * Construct a new SplFileInfo object
     * @link https://php.net/manual/zh/splfileinfo.construct.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getpath.php
    ...
    /**
     * Gets the filename
     * @link https://php.net/manual/zh/splfileinfo.getfilename.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getextension.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getbasename.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getpathname.php
     * @return string The path to the file.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/splfileinfo.getperms.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getinode.php
    ...
    /**
     * Gets file size
     * @link https://php.net/manual/zh/splfileinfo.getsize.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getowner.php
    ...
    /**
     * Gets the file group
     * @link https://php.net/manual/zh/splfileinfo.getgroup.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getatime.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getmtime.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getctime.php
    ...
    /**
     * Gets file type
     * @link https://php.net/manual/zh/splfileinfo.gettype.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.iswritable.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.isreadable.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.isexecutable.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.isfile.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.isdir.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.islink.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getlinktarget.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getrealpath.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getfileinfo.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.getpathinfo.php
     * @param string $class [optional] <p>
     * Name of an <b>SplFileInfo</b> derived class to use.
     * </p>
     ...
     * @link https://php.net/manual/zh/splfileinfo.openfile.php
     ...
     * @link https://php.net/manual/zh/splfileinfo.setfileclass.php
     * @param string $class [optional] <p>
     ...
     * @link https://php.net/manual/zh/splfileinfo.setinfoclass.php
     * @param string $class [optional] <p>
     ...
     * @link https://php.net/manual/zh/splfileinfo.tostring.php
     * @return string the path to the file.
     * @since 5.1.2
     */
 ...
 * @link https://php.net/manual/zh/class.directoryiterator.php
 */
class DirectoryIterator extends SplFileInfo implements SeekableIterator
{
    /**
     * Constructs a new directory iterator from a path
     * @link https://php.net/manual/zh/directoryiterator.construct.php
     ...
     * @link https://php.net/manual/zh/directoryiterator.isdot.php
     ...
     * @link https://php.net/manual/zh/directoryiterator.rewind.php
     * @return void
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/directoryiterator.valid.php
     ...
     * @link https://php.net/manual/zh/directoryiterator.key.php
     ...
     * @link https://php.net/manual/zh/directoryiterator.current.php
     ...
     * @link https://php.net/manual/zh/directoryiterator.next.php
     * @return void
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/directoryiterator.seek.php
     * @param int $offset <p>
 ...
 * @link https://php.net/manual/zh/class.filesystemiterator.php
 */
class FilesystemIterator extends DirectoryIterator
{
     ...
     * @link https://php.net/manual/zh/filesystemiterator.construct.php
     * @param string $directory
     ...
     * @link https://php.net/manual/zh/filesystemiterator.rewind.php
     * @return void
     */
    #[TentativeType]
    public function rewind(): void {}
     ...
     * @link https://php.net/manual/zh/filesystemiterator.next.php
     * @return void
     */
     ...
     * @link https://php.net/manual/zh/filesystemiterator.key.php
    ...
    /**
     * The current file
     * @link https://php.net/manual/zh/filesystemiterator.current.php
     ...
     * @link https://php.net/manual/zh/filesystemiterator.getflags.php
    ...
    /**
     * Sets handling flags
     * @link https://php.net/manual/zh/filesystemiterator.setflags.php
     * @param int $flags <p>
 ...
 * @link https://php.net/manual/zh/class.recursivedirectoryiterator.php
 */
class RecursiveDirectoryIterator extends FilesystemIterator implements RecursiveIterator
{
    /**
     * Constructs a RecursiveDirectoryIterator
     * @link https://php.net/manual/zh/recursivedirectoryiterator.construct.php
     * @param string $directory
     * @param int $flags [optional]
     ...
     * @link https://php.net/manual/zh/recursivedirectoryiterator.haschildren.php
     ...
     * @link https://php.net/manual/zh/recursivedirectoryiterator.getchildren.php
    ...
    /**
     * Get sub path
     * @link https://php.net/manual/zh/recursivedirectoryiterator.getsubpath.php
     ...
     * @link https://php.net/manual/zh/recursivedirectoryiterator.getsubpathname.php
 ...
 * <b>glob</b>.
 * @link https://php.net/manual/zh/class.globiterator.php
 */
class GlobIterator extends FilesystemIterator implements Countable
{
    /**
     * Construct a directory using glob
     * @link https://php.net/manual/zh/globiterator.construct.php
     * @param $pattern
     * @param int $flags [optional]
     */
    public function __construct(
     ...
     * @link https://php.net/manual/zh/globiterator.count.php
 ...
 * @link https://php.net/manual/zh/class.splfileobject.php
 */
class SplFileObject extends SplFileInfo implements RecursiveIterator, SeekableIterator
{
     ...
     *
     * @link  https://php.net/manual/zh/splfileobject.construct.php
     *
     ...
     * @link https://php.net/manual/zh/splfileobject.rewind.php
     * @return void
     */
    #[TentativeType]
    public function rewind(): void {}
    ...
    /**
     * Reached end of file
     * @link https://php.net/manual/zh/splfileobject.eof.php
    ...
    /**
     * Not at EOF
     * @link https://php.net/manual/zh/splfileobject.valid.php
    ...
    /**
     * Gets line from file
     * @link https://php.net/manual/zh/splfileobject.fgets.php
    ...
    /**
     * Read from file
     * @link https://php.net/manual/zh/splfileobject.fread.php
     * @param int $length <p>
     ...
     * @link https://php.net/manual/zh/splfileobject.fgetcsv.php
     ...
     * @link https://php.net/manual/zh/splfileobject.fputcsv.php
     ...
     * @link https://php.net/manual/zh/splfileobject.setcsvcontrol.php
     * @param string $separator [optional] <p>
     ...
     * @link https://php.net/manual/zh/splfileobject.getcsvcontrol.php
     ...
     * @link https://php.net/manual/zh/splfileobject.flock.php
     ...
     * @link https://php.net/manual/zh/splfileobject.fflush.php
     * @return bool true on success or false on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/splfileobject.ftell.php
    ...
    /**
     * Seek to a position
     * @link https://php.net/manual/zh/splfileobject.fseek.php
     * @param int $offset <p>
     ...
     * @link https://php.net/manual/zh/splfileobject.fgetc.php
     ...
     * @link https://php.net/manual/zh/splfileobject.fpassthru.php
     ...
     * @link https://php.net/manual/zh/splfileobject.fgetss.php
     ...
     * @link https://php.net/manual/zh/splfileobject.fscanf.php
    ...
    /**
     * Write to file
     * @link https://php.net/manual/zh/splfileobject.fwrite.php
     * @param string $data <p>
     ...
     * @link https://php.net/manual/zh/splfileobject.fstat.php
     ...
     * @link https://php.net/manual/zh/splfileobject.ftruncate.php
     * @param int $size <p>
     ...
     * @link https://php.net/manual/zh/splfileobject.current.php
    ...
    /**
     * Get line number
     * @link https://php.net/manual/zh/splfileobject.key.php
    ...
    /**
     * Read next line
     * @link https://php.net/manual/zh/splfileobject.next.php
     * @return void
     */
    #[TentativeType]
    public function next(): void {}
     ...
     * @link https://php.net/manual/zh/splfileobject.setflags.php
     * @param int $flags <p>
     ...
     * @link https://php.net/manual/zh/splfileobject.getflags.php
     ...
     * @link https://php.net/manual/zh/splfileobject.setmaxlinelen.php
     ...
     * @link https://php.net/manual/zh/splfileobject.getmaxlinelen.php
     ...
     * @link https://php.net/manual/zh/splfileobject.haschildren.php
     * @return bool false
     * @since 5.1.2
     */
    #[TentativeType]
    ...
    /**
     * No purpose
     * @link https://php.net/manual/zh/splfileobject.getchildren.php
     ...
     * @link https://php.net/manual/zh/splfileobject.seek.php
     * @param int $line <p>
     ...
     * @link https://php.net/manual/zh/splfileobject.getcurrentline.php
     ...
     * @link https://php.net/manual/zh/splfileobject.tostring.php
     */
    #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')]
    public function __toString() {}
}
 ...
 * @link https://php.net/manual/zh/class.spltempfileobject.php
 */
class SplTempFileObject extends SplFileObject
{
    /**
     * Construct a new temporary file object
     * @link https://php.net/manual/zh/spltempfileobject.construct.php
 ...
 * @link https://php.net/manual/zh/class.spldoublylinkedlist.php
...
class SplDoublyLinkedList implements Iterator, Countable, ArrayAccess, Serializable
{
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.pop.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.shift.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.push.php
     * @param mixed $value <p>
     * The value to push.
     * </p>
     * @return void
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.unshift.php
     * @param mixed $value <p>
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.top.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.bottom.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.count.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.isempty.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.setiteratormode.php
     * @param int $mode <p>
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.getiteratormode.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.offsetexists.php
     * @param mixed $index <p>
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.offsetget.php
     * @param mixed $index <p>
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.offsetset.php
     * @param mixed $index <p>
     * The index being set.
     * </p>
     * @param mixed $value <p>
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.offsetunset.php
     * @param mixed $index <p>
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.rewind.php
     * @return void
     */
    #[TentativeType]
    public function rewind(): void {}
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.current.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.key.php
    ...
    /**
     * Move to next entry
     * @link https://php.net/manual/zh/spldoublylinkedlist.next.php
     * @return void
     */
    #[TentativeType]
    public function next(): void {}
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.prev.php
     * @return void
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.valid.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.serialize.php
     ...
     * @link https://php.net/manual/zh/spldoublylinkedlist.unserialize.php
 ...
 * @link https://php.net/manual/zh/class.splqueue.php
 */
class SplQueue extends SplDoublyLinkedList
{
    /**
     * Adds an element to the queue.
     * @link https://php.net/manual/zh/splqueue.enqueue.php
     ...
     * @link https://php.net/manual/zh/splqueue.dequeue.php
 ...
 * @link https://php.net/manual/zh/class.splstack.php
 ...
 * @link https://php.net/manual/zh/class.splheap.php
 * @template-implements Iterator<int, TValue>
 */
abstract class SplHeap implements Iterator, Countable
{
     ...
     * @link https://php.net/manual/zh/splheap.extract.php
     ...
     * @link https://php.net/manual/zh/splheap.insert.php
     * @param TValue $value <p>
     * The value to insert.
     * </p>
     * @return bool
     ...
     * @link https://php.net/manual/zh/splheap.top.php
     ...
     * @link https://php.net/manual/zh/splheap.count.php
     ...
     * @link https://php.net/manual/zh/splheap.isempty.php
     ...
     * @link https://php.net/manual/zh/splheap.rewind.php
     * @return void
     */
    #[TentativeType]
    public function rewind(): void {}
     ...
     * @link https://php.net/manual/zh/splheap.current.php
    ...
    /**
     * Return current node index
     * @link https://php.net/manual/zh/splheap.key.php
     ...
     * @link https://php.net/manual/zh/splheap.next.php
     * @return void
     */
    #[TentativeType]
    public function next(): void {}
     ...
     * @link https://php.net/manual/zh/splheap.valid.php
     ...
     * @link https://php.net/manual/zh/splheap.recoverfromcorruption.php
     * @return bool
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/splheap.compare.php
 ...
 * @link https://php.net/manual/zh/class.splminheap.php
...
class SplMinHeap extends SplHeap
{
    /**
     * Compare elements in order to place them correctly in the heap while sifting up.
     * @link https://php.net/manual/zh/splminheap.compare.php
 ...
 * @link https://php.net/manual/zh/class.splmaxheap.php
 * @template-extends SplHeap<TValue>
 */
class SplMaxHeap extends SplHeap
{
    /**
     * Compare elements in order to place them correctly in the heap while sifting up.
     * @link https://php.net/manual/zh/splmaxheap.compare.php
     * @param TValue $value1 <p>
     * The value of the first node being compared.
     * </p>
     * @param TValue $value2 <p>
 ...
 * @link https://php.net/manual/zh/class.splpriorityqueue.php
 * @template-implements Iterator<int, TValue>
 */
class SplPriorityQueue implements Iterator, Countable
{
     ...
     * @link https://php.net/manual/zh/splpriorityqueue.compare.php
     ...
     * @link https://php.net/manual/zh/splpriorityqueue.insert.php
     * @param TValue $value <p>
     * The value to insert.
     * </p>
     ...
     * @link https://php.net/manual/zh/splpriorityqueue.setextractflags.php
     * @param int $flags <p>
     ...
     * @link https://php.net/manual/zh/splpriorityqueue.top.php
    ...
    /**
     * Extracts a node from top of the heap and sift up.
     * @link https://php.net/manual/zh/splpriorityqueue.extract.php
     ...
     * @link https://php.net/manual/zh/splpriorityqueue.count.php
     ...
     * @link https://php.net/manual/zh/splpriorityqueue.isempty.php
    ...
    /**
     * Rewind iterator back to the start (no-op)
     * @link https://php.net/manual/zh/splpriorityqueue.rewind.php
     * @return void
     */
    #[TentativeType]
    public function rewind(): void {}
    ...
    /**
     * Return current node pointed by the iterator
     * @link https://php.net/manual/zh/splpriorityqueue.current.php
    ...
    /**
     * Return current node index
     * @link https://php.net/manual/zh/splpriorityqueue.key.php
     * @return int The current node index.
     */
    #[TentativeType]
    public function key(): int {}
    ...
    /**
     * Move to the next node
     * @link https://php.net/manual/zh/splpriorityqueue.next.php
     * @return void
     */
    #[TentativeType]
    public function next(): void {}
     ...
     * @link https://php.net/manual/zh/splpriorityqueue.valid.php
     ...
     * @link https://php.net/manual/zh/splpriorityqueue.recoverfromcorruption.php
     * @return void
     */
    public function recoverFromCorruption() {}
 ...
 * implementation.
 * @link https://php.net/manual/zh/class.splfixedarray.php
 * @template-implements Iterator<int, TValue>
 * @template-implements ArrayAccess<int, TValue>
...
class SplFixedArray implements Iterator, ArrayAccess, Countable, IteratorAggregate, JsonSerializable
{
     ...
     * @link https://php.net/manual/zh/splfixedarray.construct.php
     ...
     * @link https://php.net/manual/zh/splfixedarray.count.php
     ...
     * @link https://php.net/manual/zh/splfixedarray.toarray.php
     ...
     * @link https://php.net/manual/zh/splfixedarray.fromarray.php
     * @param array $array <p>
     * The array to import.
     * </p>
     ...
     * @link https://php.net/manual/zh/splfixedarray.getsize.php
     ...
     * @link https://php.net/manual/zh/splfixedarray.setsize.php
     * @param int $size <p>
     * The new array size.
     * </p>
     * @return bool
    ...
    /**
     * Returns whether the requested index exists
     * @link https://php.net/manual/zh/splfixedarray.offsetexists.php
     * @param int $index <p>
     * The index being checked.
     * </p>
     * @return bool true if the requested <i>index</i> exists, otherwise false
    ...
    /**
     * Returns the value at the specified index
     * @link https://php.net/manual/zh/splfixedarray.offsetget.php
     * @param int $index <p>
     * The index with the value.
     * </p>
     ...
     * @link https://php.net/manual/zh/splfixedarray.offsetset.php
     * @param int $index <p>
     * The index being set.
     * </p>
     * @param TValue $value <p>
    ...
    /**
     * Unsets the value at the specified $index
     * @link https://php.net/manual/zh/splfixedarray.offsetunset.php
     * @param int $index <p>
     * The index being unset.
     * </p>
     * @return void
    ...
    /**
     * Rewind iterator back to the start
     * @link https://php.net/manual/zh/splfixedarray.rewind.php
     * @return void
     */
    public function rewind() {}
    ...
    /**
     * Return current array entry
     * @link https://php.net/manual/zh/splfixedarray.current.php
     ...
     * @link https://php.net/manual/zh/splfixedarray.key.php
    ...
    /**
     * Move to next entry
     * @link https://php.net/manual/zh/splfixedarray.next.php
     * @return void
     */
    public function next() {}
     ...
     * @link https://php.net/manual/zh/splfixedarray.valid.php
 ...
 * @link https://php.net/manual/zh/class.splobserver.php
 */
interface SplObserver
{
    /**
     * Receive update from subject
     * @link https://php.net/manual/zh/splobserver.update.php
 ...
 * @link https://php.net/manual/zh/class.splsubject.php
 */
interface SplSubject
{
    /**
     * Attach an SplObserver
     * @link https://php.net/manual/zh/splsubject.attach.php
    ...
    /**
     * Detach an observer
     * @link https://php.net/manual/zh/splsubject.detach.php
     * @param SplObserver $observer <p>
    ...
    /**
     * Notify an observer
     * @link https://php.net/manual/zh/splsubject.notify.php
     * @return void
     */
    #[TentativeType]
 ...
 * @link https://php.net/manual/zh/class.splobjectstorage.php
...
class SplObjectStorage implements Countable, Iterator, Serializable, ArrayAccess
{
     ...
     * @link https://php.net/manual/zh/splobjectstorage.attach.php
     ...
     * @link https://php.net/manual/zh/splobjectstorage.detach.php
     * @param TObject $object <p>
     ...
     * @link https://php.net/manual/zh/splobjectstorage.contains.php
     * @param TObject $object <p>
     ...
     * @link https://php.net/manual/zh/splobjectstorage.addall.php
     ...
     * @link https://php.net/manual/zh/splobjectstorage.removeall.php
     * @param SplObjectStorage<TObject, TValue> $storage <p>
     ...
     * @link https://php.net/manual/zh/splobjectstorage.removeallexcept.php
     * @param SplObjectStorage<TObject, TValue> $storage <p>
     ...
     * @link https://php.net/manual/zh/splobjectstorage.getinfo.php
     ...
     * @link https://php.net/manual/zh/splobjectstorage.setinfo.php
     * @param TValue $info <p>
     ...
     * @link https://php.net/manual/zh/splobjectstorage.count.php
     ...
     * @link https://php.net/manual/zh/splobjectstorage.rewind.php
     * @return void
     */
    #[TentativeType]
    public function rewind(): void {}
     ...
     * @link https://php.net/manual/zh/splobjectstorage.valid.php
     ...
     * @link https://php.net/manual/zh/splobjectstorage.key.php
     ...
     * @link https://php.net/manual/zh/splobjectstorage.current.php
     ...
     * @link https://php.net/manual/zh/splobjectstorage.next.php
     * @return void
     */
    #[TentativeType]
    public function next(): void {}
     ...
     * @link https://php.net/manual/zh/splobjectstorage.unserialize.php
     * @param string $data <p>
    ...
    /**
     * Serializes the storage
     * @link https://php.net/manual/zh/splobjectstorage.serialize.php
     ...
     * @link https://php.net/manual/zh/splobjectstorage.offsetexists.php
     * @param TObject $object <p>
     * The object to look for.
     * </p>
     ...
     * @link https://php.net/manual/zh/splobjectstorage.offsetset.php
     * @param TObject $object <p>
    ...
    /**
     * Removes an object from the storage
     * @link https://php.net/manual/zh/splobjectstorage.offsetunset.php
     * @param TObject $object <p>
     * The object to remove.
     * </p>
     * @return void
     ...
     * @link https://php.net/manual/zh/splobjectstorage.offsetget.php
     * @param TObject $object <p>
     * The object to look for.
     * </p>
     ...
     * @link https://php.net/manual/zh/splobjectstorage.gethash.php
     * @param TObject $object <p>
 ...
 * @link https://php.net/manual/zh/class.multipleiterator.php
 */
class MultipleIterator implements Iterator
{
     ...
     * @link https://php.net/manual/zh/multipleiterator.construct.php
     ...
     * @link https://php.net/manual/zh/multipleiterator.getflags.php
    ...
    /**
     * Sets flags
     * @link https://php.net/manual/zh/multipleiterator.setflags.php
     * @param int $flags <p>
     ...
     * @link https://php.net/manual/zh/multipleiterator.attachiterator.php
     ...
     * @link https://php.net/manual/zh/multipleiterator.detachiterator.php
     * @param Iterator $iterator <p>
     ...
     * @link https://php.net/manual/zh/multipleiterator.containsiterator.php
     * @param Iterator $iterator <p>
     ...
     * @link https://php.net/manual/zh/multipleiterator.countiterators.php
     ...
     * @link https://php.net/manual/zh/multipleiterator.rewind.php
     * @return void
     */
    #[TentativeType]
    public function rewind(): void {}
     ...
     * @link https://php.net/manual/zh/multipleiterator.valid.php
     ...
     * @link https://php.net/manual/zh/multipleiterator.key.php
    ...
    /**
     * Gets the registered iterator instances
     * @link https://php.net/manual/zh/multipleiterator.current.php
     ...
     * @link https://php.net/manual/zh/multipleiterator.next.php
     * @return void
     */
    #[TentativeType]
    public function next(): void {}
