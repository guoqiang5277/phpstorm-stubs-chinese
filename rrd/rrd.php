 ...
 * @link     https://php.net/manual/zh/book.rrd.php
 ...
 * @link https://php.net/manual/zh/function.rrdc-disconnect.php
 * @return void
...
class RRDCreator
{
     ...
     * @link https://php.net/manual/zh/rrdcreator.construct.php
     * @param string $path <p>
...
class RRDGraph
{
     ...
     * @link https://php.net/manual/zh/rrdgraph.construct.php
     * @param string $path <p>
...
class RRDUpdater
{
     ...
     * @link https://php.net/manual/zh/rrdupdater.construct.php
     * @param string $path <p>
