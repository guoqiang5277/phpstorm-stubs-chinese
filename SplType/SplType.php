 ...
 *
 * @link https://php.net/manual/zh/class.spltype.php
 */
abstract class SplType
{
    /**
     * @var null Default value
     * @link https://php.net/manual/zh/class.spltype.php#spltype.constants.default
     */
     ...
     * @link https://php.net/manual/zh/spltype.construct.php
     */
 ...
 *
 * @link https://php.net/manual/zh/class.splint.php
 */
class SplInt extends SplType
{
    /**
     * @link https://php.net/manual/zh/class.splint.php#splint.constants.default
     */
 ...
 *
 * @link https://php.net/manual/zh/class.splfloat.php
 */
 ...
 *
 * @link https://php.net/manual/zh/class.splenum.php
 */
class SplEnum extends SplType
{
    /**
     * @link https://php.net/manual/zh/class.splenum.php#splenum.constants.default
     */
    public const __default = null;
     ...
     * @return array
     * @link https://php.net/manual/zh/splenum.getconstlist.php
     */
 ...
 *
 * @link https://php.net/manual/zh/class.splbool.php
 */
class SplBool extends SplEnum
{
    /**
     * @link https://php.net/manual/zh/class.splbool.php#splbool.constants.default
     */
    public const __default = false;

    /**
     * @link https://php.net/manual/zh/class.splbool.php#splbool.constants.false
     */
    public const false = false;

    /**
     * @link https://php.net/manual/zh/class.splbool.php#splbool.constants.true
     */
 ...
 *
 * @link https://php.net/manual/zh/class.splstring.php
 */
class SplString extends SplType
{
    /**
     * @link https://php.net/manual/zh/class.splstring.php#splstring.constants.default
     */
    public const __default = 0;
}
