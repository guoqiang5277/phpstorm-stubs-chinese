...
/**
 * Get the local time
 * @link https://php.net/manual/zh/function.localtime.php
 * @param int|null $timestamp [optional]
 ...
 * @link https://php.net/manual/zh/function.getdate.php
 * @param int|null $timestamp [optional]
 ...
 * @link https://php.net/manual/zh/function.date-parse.php
 * @param string $datetime <p>
 ...
 * @link https://php.net/manual/zh/function.date-parse-from-format.php
 * @param string $format <p>
 ...
 * @link https://php.net/manual/zh/function.timezone-location-get.php
 ...
 * @link https://php.net/manual/zh/function.date-sun-info.php
 * @param int $timestamp <p>
 * Timestamp.
 * </p>
