 ...
 * @link https://php.net/manual/zh/class.snmp.php
 */
class SNMP
{
    /**
     ...
     * @link https://php.net/manual/zh/snmp.construct.php
    ...
    /**
     * Close SNMP session
     * @link https://php.net/manual/zh/snmp.close.php
     ...
     * @link https://php.net/manual/zh/snmp.setsecurity.php
     ...
     * @link https://php.net/manual/zh/snmp.get.php
     ...
     * @link https://php.net/manual/zh/snmp.getnext.php
     ...
     * @link https://php.net/manual/zh/snmp.walk.php
     ...
     * @link https://php.net/manual/zh/snmp.set.php
    ...
    /**
     * Get last error code
     * @link https://php.net/manual/zh/snmp.geterrno.php
     ...
     * @link https://php.net/manual/zh/snmp.geterror.php
 ...
 * @link https://php.net/manual/zh/class.snmpexception.php
 */
