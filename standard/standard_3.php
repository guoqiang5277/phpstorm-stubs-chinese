 ...
 * @link https://php.net/manual/zh/function.getlastmod.php
 ...
 * @link https://php.net/manual/zh/function.base64-decode.php
 ...
 * @link https://php.net/manual/zh/function.base64-encode.php
 * @param string $string <p>
 * The data to encode.
 * </p>
...
/**
 * Uuencode a string
 * @link https://php.net/manual/zh/function.convert-uuencode.php
 * @param string $string <p>
 ...
 * @link https://php.net/manual/zh/function.convert-uudecode.php
 * @param string $string <p>
 * The uuencoded data.
 * </p>
...
/**
 * Absolute value
 * @link https://php.net/manual/zh/function.abs.php
...
/**
 * Round fractions up
 * @link https://php.net/manual/zh/function.ceil.php
 * @param int|float $num <p>
 * The value to round
 * </p>
 ...
 * @link https://php.net/manual/zh/function.floor.php
 * @param int|float $num <p>
 ...
 * @link https://php.net/manual/zh/function.round.php
 * @param int|float $num <p>
 * The value to round
 * </p>
...
/**
 * Sine
 * @link https://php.net/manual/zh/function.sin.php
 * @param float $num <p>
 * A value in radians
 * </p>
...
/**
 * Cosine
 * @link https://php.net/manual/zh/function.cos.php
 * @param float $num <p>
 * An angle in radians
 * </p>
...
/**
 * Tangent
 * @link https://php.net/manual/zh/function.tan.php
 * @param float $num <p>
...
/**
 * Arc sine
 * @link https://php.net/manual/zh/function.asin.php
 * @param float $num <p>
...
/**
 * Arc cosine
 * @link https://php.net/manual/zh/function.acos.php
 * @param float $num <p>
 * The argument to process
 * </p>
...
/**
 * Arc tangent
 * @link https://php.net/manual/zh/function.atan.php
 * @param float $num <p>
 * The argument to process
 * </p>
 ...
 * @link https://php.net/manual/zh/function.atanh.php
 * @param float $num <p>
 * The argument to process
 * </p>
 ...
 * @link https://php.net/manual/zh/function.atan2.php
 * @param float $y <p>
 * Dividend parameter
 * </p>
 * @param float $x <p>
...
/**
 * Hyperbolic sine
 * @link https://php.net/manual/zh/function.sinh.php
 * @param float $num <p>
 * The argument to process
 * </p>
...
/**
 * Hyperbolic cosine
 * @link https://php.net/manual/zh/function.cosh.php
 * @param float $num <p>
 * The argument to process
 * </p>
...
/**
 * Hyperbolic tangent
 * @link https://php.net/manual/zh/function.tanh.php
 * @param float $num <p>
 * The argument to process
 * </p>
 ...
 * @link https://php.net/manual/zh/function.asinh.php
 * @param float $num <p>
 * The argument to process
 * </p>
 ...
 * @link https://php.net/manual/zh/function.acosh.php
 * @param float $num <p>
 ...
 * @link https://php.net/manual/zh/function.expm1.php
 * @param float $num <p>
 * The argument to process
 * </p>
 ...
 * @link https://php.net/manual/zh/function.log1p.php
 * @param float $num <p>
 * The argument to process
 * </p>
...
/**
 * Get value of pi
 * @link https://php.net/manual/zh/function.pi.php
 ...
 * @link https://php.net/manual/zh/function.is-finite.php
 * @param float $num <p>
 * The value to check
 * </p>
 ...
 * @link https://php.net/manual/zh/function.is-nan.php
 * @param float $num <p>
 * The value to check
 * </p>
...
/**
 * Integer division
 * @link https://php.net/manual/zh/function.intdiv.php
 ...
 * @link https://php.net/manual/zh/function.is-infinite.php
 * @param float $num <p>
 * The value to check
 * </p>
 ...
 * @link https://php.net/manual/zh/function.pow.php
 * @param mixed $num <p>
 * The base to use
 * </p>
 ...
 * @link https://php.net/manual/zh/function.exp.php
 * @param float $num <p>
 * The argument to process
 * </p>
...
/**
 * Natural logarithm
 * @link https://php.net/manual/zh/function.log.php
 * @param float $num <p>
...
/**
 * Base-10 logarithm
 * @link https://php.net/manual/zh/function.log10.php
 * @param float $num <p>
 * The argument to process
 * </p>
...
/**
 * Square root
 * @link https://php.net/manual/zh/function.sqrt.php
 * @param float $num <p>
 * The argument to process
 * </p>
 ...
 * @link https://php.net/manual/zh/function.hypot.php
 * @param float $x <p>
 ...
 * @link https://php.net/manual/zh/function.deg2rad.php
 * @param float $num <p>
 ...
 * @link https://php.net/manual/zh/function.rad2deg.php
 * @param float $num <p>
 * A radian value
 * </p>
...
/**
 * Binary to decimal
 * @link https://php.net/manual/zh/function.bindec.php
 ...
 * @link https://php.net/manual/zh/function.hexdec.php
...
/**
 * Octal to decimal
 * @link https://php.net/manual/zh/function.octdec.php
...
/**
 * Decimal to binary
 * @link https://php.net/manual/zh/function.decbin.php
 * @param int $num <p>
...
/**
 * Decimal to octal
 * @link https://php.net/manual/zh/function.decoct.php
 * @param int $num <p>
 * Decimal value to convert
 * </p>
 ...
 * @link https://php.net/manual/zh/function.dechex.php
 * @param int $num <p>
 * Decimal value to convert
 * </p>
 ...
 * @link https://php.net/manual/zh/function.base-convert.php
 * @param string $num <p>
 ...
 * @link https://php.net/manual/zh/function.number-format.php
 * @param float $num <p>
 ...
 * of the arguments
 * @link https://php.net/manual/zh/function.fmod.php
 * @param float $num1 <p>
 * The dividend
 * </p>
 * @param float $num2 <p>
 ...
 * @link https://php.net/manual/zh/function.inet-ntop.php
 * @param string $ip <p>
 ...
 * @link https://php.net/manual/zh/function.inet-pton.php
 * @param string $ip <p>
 ...
 * @link https://php.net/manual/zh/function.ip2long.php
 * @param string $ip <p>
 ...
 * @link https://php.net/manual/zh/function.long2ip.php
 * @param int $ip <p>
 ...
 * @link https://php.net/manual/zh/function.getenv.php
 ...
 * @link https://php.net/manual/zh/function.putenv.php
 ...
 * @link https://php.net/manual/zh/function.getopt.php
 ...
 * @link https://php.net/manual/zh/function.sys-getloadavg.php
 ...
 * @link https://php.net/manual/zh/function.microtime.php
...
/**
 * Get current time
 * @link https://php.net/manual/zh/function.gettimeofday.php
 * @param bool $as_float [optional] <p>
 ...
 * @link https://php.net/manual/zh/function.getrusage.php
 * @param int $mode <p>
 ...
 * @link https://php.net/manual/zh/function.uniqid.php
 ...
 * @link https://php.net/manual/zh/function.quoted-printable-decode.php
 * @param string $string <p>
 * The input string.
 * </p>
 ...
 * @link https://php.net/manual/zh/function.quoted-printable-encode.php
 * @param string $string <p>
 * The input string.
 * </p>
 ...
 * @link https://php.net/manual/zh/function.convert-cyr-string.php
 * @param string $str <p>
 ...
 * @link https://php.net/manual/zh/function.get-current-user.php
 ...
 * @link https://php.net/manual/zh/function.set-time-limit.php
 * @param int $seconds <p>
 ...
 * @link https://php.net/manual/zh/function.get-cfg-var.php
 ...
 * @link https://php.net/manual/zh/function.magic-quotes-runtime.php
 ...
 * @link https://php.net/manual/zh/function.set-magic-quotes-runtime.php
 ...
 * @link https://php.net/manual/zh/function.get-magic-quotes-gpc.php
 ...
 * @link https://php.net/manual/zh/function.get-magic-quotes-runtime.php
 ...
 * @link https://php.net/manual/zh/function.import-request-variables.php
 ...
 * @link https://php.net/manual/zh/function.error-log.php
