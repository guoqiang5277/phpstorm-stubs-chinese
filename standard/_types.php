...
namespace {
    ...
    final class Generator implements Iterator
    {
         ...
         * @link https://php.net/manual/zh/generator.wakeup.php
         * @return void
         */
...
namespace ___PHPSTORM_HELPERS {
    ...
    class object
    {
         ...
         *
         * param [ mixed $args [, $... ]]
         * @link https://php.net/manual/zh/language.oop5.decon.php
         */
         ...
         * @return mixed
         * @link https://php.net/manual/zh/language.oop5.overloading.php#language.oop5.overloading.methods
         */
         ...
         * @param string $name
         * @return mixed
         * @link https://php.net/manual/zh/language.oop5.overloading.php#language.oop5.overloading.members
         */
         ...
         *
         * @return string[]
         * @link https://php.net/manual/zh/language.oop5.magic.php#language.oop5.magic.sleep
         */
         ...
         *
         * @return string
         * @link https://php.net/manual/zh/language.oop5.magic.php#language.oop5.magic.tostring
         */
         ...
         *
         * @return mixed
         * @link https://php.net/manual/zh/language.oop5.magic.php#language.oop5.magic.invoke
         */
         ...
         *
         * @return array|null
         * @link https://php.net/manual/zh/language.oop5.magic.php#language.oop5.magic.debuginfo
         */
         ...
         * @return object
         * @link https://php.net/manual/zh/language.oop5.magic.php#language.oop5.magic.set-state
         */
         ...
         *
         * @return void
         * @link https://php.net/manual/zh/language.oop5.cloning.php
         */
