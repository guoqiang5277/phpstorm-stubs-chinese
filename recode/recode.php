 ...
 * @link https://php.net/manual/zh/function.recode-string.php
 ...
 * @link https://php.net/manual/zh/function.recode-file.php
 * @param string $request <p>
 * The desired recode request type
 * </p>
 ...
 * @link https://php.net/manual/zh/function.recode.php
 * @param $request
 * @param $str
 * @removed 7.4
 */
