 ...
 * @see https://php.net/manual/zh/language.exceptions.php Exceptions in PHP
 * @link https://php.net/manual/zh/class.pdoexception.php
 */
 ...
 * @link https://php.net/manual/zh/class.pdo.php
 */
class PDO
{
    /**
     * Represents the SQL NULL data type.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-null
     */
    public const PARAM_NULL = 0;

    /**
     * Represents the SQL INTEGER data type.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-int
     */
    public const PARAM_INT = 1;

    /**
     * Represents the SQL CHAR, VARCHAR, or other string data type.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-str
     */
    public const PARAM_STR = 2;

    /**
     * Represents the SQL large object data type.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-lob
     */
    public const PARAM_LOB = 3;

    /**
     * Represents a recordset type. Not currently supported by any drivers.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-stmt
     */
    public const PARAM_STMT = 4;

    /**
     * Represents a boolean data type.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-bool
     */
     ...
     * @since 7.2
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-str-natl
     */
     ...
     * @since 7.2
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-str-char
     */
     ...
     * @since 7.2
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-default-str-param
     */
     ...
     * @since 7.1.4
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.sqlite-deterministic
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-input-output
     */
    public const PARAM_INPUT_OUTPUT = 2147483648;

    /**
     * Allocation event
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-evt-alloc
     */
    public const PARAM_EVT_ALLOC = 0;

    /**
     * Deallocation event
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-evt-free
     */
    public const PARAM_EVT_FREE = 1;

    /**
     * Event triggered prior to execution of a prepared statement.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-evt-exec-pre
     */
    public const PARAM_EVT_EXEC_PRE = 2;

    /**
     * Event triggered subsequent to execution of a prepared statement.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-evt-exec-post
     */
    public const PARAM_EVT_EXEC_POST = 3;

    /**
     * Event triggered prior to fetching a result from a resultset.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-evt-fetch-pre
     */
    public const PARAM_EVT_FETCH_PRE = 4;

    /**
     * Event triggered subsequent to fetching a result from a resultset.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-evt-fetch-post
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.param-evt-normalize
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-lazy
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-assoc
     */
     ...
     * column 0.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-num
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-both
     */
     ...
     * set.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-obj
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-bound
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-column
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-class
     */
     ...
     * requested class, mapping the columns to named properties in the class.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-into
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-func
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-group
     */
    public const FETCH_GROUP = 65536;

    /**
     * Fetch only the unique values.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-unique
     */
     ...
     * is the value.
     * @since 5.2.3
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-key-pair
     */
    public const FETCH_KEY_PAIR = 12;

    /**
     * Determine the class name from the value of first column.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-classtype
     */
     ...
     * flag is set.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-serialize
     */
     ...
     * @since 5.2.0
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-props-late
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-named
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-autocommit
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-prefetch
     */
    public const ATTR_PREFETCH = 1;

    /**
     * Sets the timeout value in seconds for communications with the database.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-timeout
     */
    public const ATTR_TIMEOUT = 2;

    /**
     * @see https://php.net/manual/zh/pdo.error-handling.php Errors and error handling
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-errmode
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-client-version
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-server-info
     */
     ...
     * constants.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-case
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-cursor-name
     */
     ...
     * scrollable cursor.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-cursor
     */
    public const ATTR_CURSOR = 10;

    /**
     * Convert empty strings to SQL NULL values on data fetches.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-oracle-nulls
     */
    public const ATTR_ORACLE_NULLS = 11;

    /**
     * Request a persistent connection, rather than creating a new connection.
     * @see https://php.net/manual/zh/pdo.connections.php Connections and Connection Management
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-persistent
     */
    public const ATTR_PERSISTENT = 12;

    /**
     * Sets the class name of which statements are returned as.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-statement-class
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-fetch-table-names
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-fetch-catalog-names
     */
     ...
     * </code>
     * </p>
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-driver-name
     */
    public const ATTR_DRIVER_NAME = 16;

    /**
     * Forces all values fetched to be treated as strings.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-stringify-fetches
     */
    public const ATTR_STRINGIFY_FETCHES = 17;

    /**
     * Sets the maximum column name length.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-max-column-len
     */
    public const ATTR_MAX_COLUMN_LEN = 18;

    /**
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-emulate-prepares
     * @since 5.1.3
     */
    public const ATTR_EMULATE_PREPARES = 20;

    /**
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.attr-default-fetch-mode
     * @since 5.2.0
     */
     ...
     * @see https://php.net/manual/zh/pdo.error-handling.php  Errors and Error Handling
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.errmode-silent
     */
     ...
     * @see https://php.net/manual/zh/pdo.error-handling.php  Errors and Error Handling
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.errmode-warning
     */
     ...
     * @see https://php.net/manual/zh/pdo.error-handling.php  Errors and Error Handling
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.errmode-exception
     */
    public const ERRMODE_EXCEPTION = 2;

    /**
     * Leave column names as returned by the database driver.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.case-natural
     */
    public const CASE_NATURAL = 0;

    /**
     * Force column names to lower case.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.case-lower
     */
    public const CASE_LOWER = 2;

    /**
     * Force column names to upper case.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.case-upper
     */
    public const CASE_UPPER = 1;

    /**
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.null-natural
     */
    public const NULL_NATURAL = 0;

    /**
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.null-empty-string
     */
    public const NULL_EMPTY_STRING = 1;

    /**
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.null-to-string
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.err-none
     */
    public const ERR_NONE = '00000';

    /**
     * Fetch the next row in the result set. Valid only for scrollable cursors.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-ori-next
     */
     ...
     * cursors.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-ori-prior
     */
    public const FETCH_ORI_PRIOR = 1;

    /**
     * Fetch the first row in the result set. Valid only for scrollable cursors.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-ori-first
     */
    public const FETCH_ORI_FIRST = 2;

    /**
     * Fetch the last row in the result set. Valid only for scrollable cursors.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-ori-last
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-ori-abs
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-ori-rel
     */
     ...
     * @since 8.0.7
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.fetch-default
     */
     ...
     * pattern in PHP.
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.cursor-fwdonly
     */
     ...
     * @link https://php.net/manual/zh/pdo.constants.php#pdo.constants.cursor-scroll
     */
     ...
     * </code>
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-use-buffered-query
     */
     ...
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-local-infile
     */
     ...
     * array when constructing a new database handle.
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-init-command
     */
     ...
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-max-buffer-size
     */
     ...
     * configuration files.
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-read-default-file
     */
     ...
     * configuration files.
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-read-default-group
     */
     ...
     * compiled against mysqlnd.
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-compress
     */
     ...
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-direct-query
     */
     ...
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-found-rows
     */
     ...
     * </p>
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-ignore-space
     */
     ...
     * </p>
     * @since 5.3.7
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-ssl-key
     */
     ...
     * </p>
     * @since 5.3.7
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-ssl-cert
     */
     ...
     * </p>
     * @since 5.3.7
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-ssl-ca
     */
     ...
     * </p>
     * @since 5.3.7
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-ssl-capath
     */
     ...
     * </p>
     * @since 5.3.7
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-cipher
     */
     ...
     * </p>
     * @since 5.5.21
     * @link https://php.net/manual/zh/ref.pdo-mysql.php#pdo.constants.mysql-attr-multi-statements
     */
     ...
     * @link https://php.net/manual/zh/pdo.construct.php
     * @param string $dsn
     ...
     * @link https://php.net/manual/zh/pdo.prepare.php
     ...
     * </p>
     * @link https://php.net/manual/zh/pdo.begintransaction.php
     ...
     * @link https://php.net/manual/zh/pdo.commit.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     ...
     * @link https://php.net/manual/zh/pdo.rollback.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @throws PDOException if there is no active transaction.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/pdo.intransaction.php
     ...
     * (PHP 5 &gt;= 5.1.0, PHP 7, PECL pdo &gt;= 0.1.0)<br/>
     * Set an attribute
     * @link https://php.net/manual/zh/pdo.setattribute.php
     * @param int $attribute
     * @param mixed $value
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/zh/pdo.exec.php
     ...
     * @link https://php.net/manual/zh/pdo.query.php
     * @param string $query <p>
     * The SQL statement to prepare and execute.
     * </p>
     * <p>
     ...
     * @link https://php.net/manual/zh/pdo.lastinsertid.php
     ...
     * @link https://php.net/manual/zh/pdo.errorcode.php
     ...
     * @link https://php.net/manual/zh/pdo.errorinfo.php
     ...
     * @link https://php.net/manual/zh/pdo.getattribute.php
     ...
     * @link https://php.net/manual/zh/pdo.quote.php
     ...
     * @link https://php.net/manual/zh/pdo.getavailabledrivers.php
     ...
     * @link https://php.net/manual/zh/pdo.sqlitecreateaggregate.php
     ...
     * @link https://php.net/manual/zh/pdo.sqlitecreatecollation.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/zh/pdo.sqlitecreatefunction.php
     * @param string $function_name <p>
     * The name of the function used in SQL statements.
     * </p>
     * @param callable $callback <p>
 ...
 * @link https://php.net/manual/zh/class.pdostatement.php
 */
class PDOStatement implements IteratorAggregate
{
     ...
     * @link https://php.net/manual/zh/pdostatement.execute.php
     ...
     * @link https://php.net/manual/zh/pdostatement.fetch.php
     ...
     * @link https://php.net/manual/zh/pdostatement.bindparam.php
     * @param mixed $param <p>
     ...
     * @link https://php.net/manual/zh/pdostatement.bindcolumn.php
     ...
     * @link https://php.net/manual/zh/pdostatement.bindvalue.php
     * @param mixed $param <p>
     * Parameter identifier. For a prepared statement using named
     * placeholders, this will be a parameter name of the form
     * :name. For a prepared statement using
     ...
     * @link https://php.net/manual/zh/pdostatement.rowcount.php
     ...
     * @link https://php.net/manual/zh/pdostatement.fetchcolumn.php
     ...
     * @link https://php.net/manual/zh/pdostatement.fetchall.php
     * @param int $mode [optional] <p>
     ...
     * @link https://php.net/manual/zh/pdostatement.fetchobject.php
     ...
     * @link https://php.net/manual/zh/pdostatement.errorcode.php
     ...
     * @link https://php.net/manual/zh/pdostatement.errorinfo.php
     ...
     * @link https://php.net/manual/zh/pdostatement.setattribute.php
     * @param int $attribute
     * @param mixed $value
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://php.net/manual/zh/pdostatement.getattribute.php
     * @param int $name
     ...
     * @link https://php.net/manual/zh/pdostatement.columncount.php
     ...
     * @link https://php.net/manual/zh/pdostatement.getcolumnmeta.php
     * @param int $column <p>
     ...
     * @link https://php.net/manual/zh/pdostatement.setfetchmode.php
     * @param int $mode <p>
     * The fetch mode must be one of the PDO::FETCH_* constants.
     * </p>
     ...
     * @link https://php.net/manual/zh/pdostatement.nextrowset.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/pdostatement.closecursor.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/pdostatement.debugdumpparams.php
