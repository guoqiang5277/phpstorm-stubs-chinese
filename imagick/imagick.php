 ...
 * @link https://php.net/manual/zh/class.imagick.php
 */
class Imagick implements Iterator, Countable
{
     ...
     * @link https://php.net/manual/zh/imagick.optimizeimagelayers.php
     ...
     * @link https://php.net/manual/zh/imagick.compareimagelayers.php
     * @param int $method <p>
     ...
     * @link https://php.net/manual/zh/imagick.pingimageblob.php
     ...
     * @link https://php.net/manual/zh/imagick.pingimagefile.php
     ...
     * @link https://php.net/manual/zh/imagick.transposeimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.transverseimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.trimimage.php
     * @param float $fuzz <p>
     ...
     * @link https://php.net/manual/zh/imagick.waveimage.php
     ...
     * @link https://php.net/manual/zh/imagick.vignetteimage.php
     ...
     * @link https://php.net/manual/zh/imagick.uniqueimagecolors.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.getimagematte.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagematte.php
     * @param bool $matte <p>
     ...
     * @link https://php.net/manual/zh/imagick.adaptiveresizeimage.php
     ...
     * @link https://php.net/manual/zh/imagick.sketchimage.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a 3D effect
     * @link https://php.net/manual/zh/imagick.shadeimage.php
     * @param bool $gray <p>
     ...
     * @link https://php.net/manual/zh/imagick.getsizeoffset.php
     ...
     * @link https://php.net/manual/zh/imagick.setsizeoffset.php
     * @param int $columns <p>
     * The width in pixels.
     * </p>
     * @param int $rows <p>
     ...
     * @link https://php.net/manual/zh/imagick.adaptiveblurimage.php
     * @param float $radius <p>
     * The radius of the Gaussian, in pixels, not counting the center pixel.
     ...
     * @link https://php.net/manual/zh/imagick.contraststretchimage.php
     ...
     * @link https://php.net/manual/zh/imagick.adaptivesharpenimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/zh/imagick.randomthresholdimage.php
     * @param float $low <p>
     * The low point
     * </p>
     * @param float $high <p>
     ...
     * @link https://php.net/manual/zh/imagick.roundcorners.php
     ...
     * @link https://php.net/manual/zh/imagick.setiteratorindex.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/zh/imagick.getiteratorindex.php
     ...
     * @link https://php.net/manual/zh/imagick.transformimage.php
     * @param string $crop <p>
     ...
     * @link https://php.net/manual/zh/imagick.setimageopacity.php
     ...
     * @link https://php.net/manual/zh/imagick.orderedposterizeimage.php
     ...
     * @link https://php.net/manual/zh/imagick.polaroidimage.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageproperty.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/zh/imagick.setimageproperty.php
     * @param string $name
     * @param string $value
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.setimageinterpolatemethod.php
     * @param int $method <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimageinterpolatemethod.php
     ...
     * @link https://php.net/manual/zh/imagick.linearstretchimage.php
     * @param float $blackPoint <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimagelength.php
     ...
     * Set image size
     * @link https://php.net/manual/zh/imagick.extentimage.php
     * @param int $width <p>
     * The new width
     * </p>
     * @param int $height <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimageorientation.php
     ...
     * @link https://php.net/manual/zh/imagick.setimageorientation.php
     ...
     * @link https://php.net/manual/zh/imagick.paintfloodfillimage.php
     * @param mixed $fill <p>
     ...
     * @link https://php.net/manual/zh/imagick.clutimage.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageproperties.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageprofiles.php
     * @param string $pattern [optional] <p>
     ...
     * @link https://php.net/manual/zh/imagick.distortimage.php
     * @param int $method <p>
     ...
     * @link https://php.net/manual/zh/imagick.writeimagefile.php
     * @param resource $filehandle <p>
     ...
     * @link https://php.net/manual/zh/imagick.writeimagesfile.php
     * @param resource $filehandle <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Reset image page
     * @link https://php.net/manual/zh/imagick.resetimagepage.php
     * @param string $page <p>
     ...
     * @link https://php.net/manual/zh/imagick.setimageclipmask.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageclipmask.php
     ...
     * @link https://php.net/manual/zh/imagick.animateimages.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Recolors image
     * @link https://php.net/manual/zh/imagick.recolorimage.php
     ...
     * (PECL imagick 2.1.0)<br/>
     * Sets font
     * @link https://php.net/manual/zh/imagick.setfont.php
     * @param string $font <p>
     ...
     * (PECL imagick 2.1.0)<br/>
     * Gets font
     * @link https://php.net/manual/zh/imagick.getfont.php
     ...
     * (PECL imagick 2.1.0)<br/>
     * Sets point size
     * @link https://php.net/manual/zh/imagick.setpointsize.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Gets point size
     * @link https://php.net/manual/zh/imagick.getpointsize.php
     ...
     * (PECL imagick 2.1.0)<br/>
     * Merges image layers
     * @link https://php.net/manual/zh/imagick.mergeimagelayers.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagealphachannel.php
     * @param int $mode <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Changes the color value of any pixel that matches target
     * @link https://php.net/manual/zh/imagick.floodfillpaintimage.php
     * @param mixed $fill <p>
     * ImagickPixel object or a string containing the fill color
     * </p>
     * @param float $fuzz <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Changes the color value of any pixel that matches target
     * @link https://php.net/manual/zh/imagick.opaquepaintimage.php
     * @param mixed $target <p>
     ...
     * @link https://php.net/manual/zh/imagick.transparentpaintimage.php
     * @param mixed $target <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Animates an image or images
     * @link https://php.net/manual/zh/imagick.liquidrescaleimage.php
     * @param int $width <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Enciphers an image
     * @link https://php.net/manual/zh/imagick.encipherimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Deciphers an image
     * @link https://php.net/manual/zh/imagick.decipherimage.php
     * @param string $passphrase <p>
     * The passphrase
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * (No version information available, might only be in SVN)<br/>
     * Sets the gravity
     * @link https://php.net/manual/zh/imagick.setgravity.php
     * @param int $gravity <p>
     ...
     * (No version information available, might only be in SVN)<br/>
     * Gets the gravity
     * @link https://php.net/manual/zh/imagick.getgravity.php
     ...
     * Gets channel range
     * @link https://php.net/manual/zh/imagick.getimagechannelrange.php
     * @param int $channel <p>
     * Provide any channel constant that is valid for your channel mode. To apply to more than one channel, combine channel constants using bitwise operators. Defaults to <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     * </p>
     ...
     * @link https://php.net/manual/zh/imagick.getimagealphachannel.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagechanneldistortions.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagegravity.php
     * @param int $gravity <p>
     * The gravity property. Refer to the list of
     * gravity constants.
     * </p>
     ...
     * @link https://php.net/manual/zh/imagick.getimagegravity.php
     ...
     * @link https://php.net/manual/zh/imagick.importimagepixels.php
     * @param int $x <p>
     ...
     * @link https://php.net/manual/zh/imagick.deskewimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Segments an image
     * @link https://php.net/manual/zh/imagick.segmentimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Interpolates colors
     * @link https://php.net/manual/zh/imagick.sparsecolorimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Remaps image colors
     * @link https://php.net/manual/zh/imagick.remapimage.php
     ...
     * @link https://php.net/manual/zh/imagick.exportimagepixels.php
     * @param int $x <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimagechannelkurtosis.php
     * @param int $channel [optional] <p>
     * Provide any channel constant that is valid for your channel mode. To apply to more than one channel, combine channel constants using bitwise operators. Defaults to <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     * </p>
     ...
     * @link https://php.net/manual/zh/imagick.functionimage.php
     ...
     * @link https://php.net/manual/zh/imagick.haldclutimage.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Get image artifact
     * @link https://php.net/manual/zh/imagick.getimageartifact.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Set image artifact
     * @link https://php.net/manual/zh/imagick.setimageartifact.php
     * @param string $artifact <p>
     * The name of the artifact
     * </p>
     ...
     * @link https://php.net/manual/zh/imagick.deleteimageartifact.php
     * @param string $artifact <p>
     ...
     * Gets the colorspace
     * @link https://php.net/manual/zh/imagick.getcolorspace.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Set colorspace
     * @link https://php.net/manual/zh/imagick.setcolorspace.php
     * @param int $COLORSPACE <p>
     * One of the COLORSPACE constants
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/zh/imagick.construct.php
     * @param mixed $files <p>
     ...
     * @link https://php.net/manual/zh/imagick.getpixeliterator.php
     ...
     * @link https://php.net/manual/zh/imagick.getpixelregioniterator.php
     * @param int $x <p>
     ...
     * @link https://php.net/manual/zh/imagick.readimage.php
     ...
     * @link https://php.net/manual/zh/imagick.readimageblob.php
     * @param string $image
     ...
     * @link https://php.net/manual/zh/imagick.setimageformat.php
     ...
     * @link https://php.net/manual/zh/imagick.scaleimage.php
     * @param int $columns
     * @param int $rows
     ...
     * @link https://php.net/manual/zh/imagick.writeimage.php
     * @param string $filename [optional] <p>
     ...
     * @link https://php.net/manual/zh/imagick.writeimages.php
     * @param string $filename
     * @param bool $adjoin
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.blurimage.php
     * @param float $radius <p>
     * Blur radius
     * </p>
     * @param float $sigma <p>
     ...
     * @link https://php.net/manual/zh/imagick.thumbnailimage.php
     * @param int $columns <p>
     * Image width
     * </p>
     * @param int $rows <p>
     ...
     * @link https://php.net/manual/zh/imagick.cropthumbnailimage.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagefilename.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagefilename.php
     * @param string $filename
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.getimageformat.php
     ...
     * @link https://php.net/manual/zh/imagick.removeimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.destroy.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/zh/imagick.clear.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns the image length in bytes
     * @link https://php.net/manual/zh/imagick.getimagesize.php
     * @return int an int containing the current image size.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.getimageblob.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagesblob.php
     ...
     * @link https://php.net/manual/zh/imagick.setfirstiterator.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setlastiterator.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/zh/imagick.previousimage.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/zh/imagick.nextimage.php
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/zh/imagick.haspreviousimage.php
     ...
     * @link https://php.net/manual/zh/imagick.hasnextimage.php
     * @return bool <b>TRUE</b> if the object has more images when traversing the list in the
     ...
     * (PECL imagick 2.0.0)<br/>
     * Set the iterator position
     * @link https://php.net/manual/zh/imagick.setimageindex.php
     * @param int $index <p>
     * The position to set the iterator to
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * (PECL imagick 2.0.0)<br/>
     * Gets the index of the current active image
     * @link https://php.net/manual/zh/imagick.getimageindex.php
     * @return int an integer containing the index of the image in the stack.
     */
    #[Deprecated]
    #[Pure]
     ...
     * @link https://php.net/manual/zh/imagick.commentimage.php
     ...
     * @link https://php.net/manual/zh/imagick.cropimage.php
     * @param int $width <p>
     ...
     * @link https://php.net/manual/zh/imagick.labelimage.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagegeometry.php
     ...
     * @link https://php.net/manual/zh/imagick.drawimage.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagecompressionquality.php
     * @param int $quality <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimagecompressionquality.php
     ...
     * @link https://php.net/manual/zh/imagick.annotateimage.php
     ...
     * @link https://php.net/manual/zh/imagick.compositeimage.php
     ...
     * @link https://php.net/manual/zh/imagick.modulateimage.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagecolors.php
     ...
     * @link https://php.net/manual/zh/imagick.montageimage.php
     * @param ImagickDraw $draw <p>
     ...
     * @link https://php.net/manual/zh/imagick.identifyimage.php
     ...
     * @link https://php.net/manual/zh/imagick.thresholdimage.php
     ...
     * @link https://php.net/manual/zh/imagick.adaptivethresholdimage.php
     * @param int $width <p>
     ...
     * @link https://php.net/manual/zh/imagick.blackthresholdimage.php
     ...
     * @link https://php.net/manual/zh/imagick.whitethresholdimage.php
     ...
     * @link https://php.net/manual/zh/imagick.appendimages.php
     ...
     * @link https://php.net/manual/zh/imagick.charcoalimage.php
     * @param float $radius <p>
     * The radius of the Gaussian, in pixels, not counting the center pixel
     * </p>
     * @param float $sigma <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Enhances the contrast of a color image
     * @link https://php.net/manual/zh/imagick.normalizeimage.php
     * @param int $channel [optional] <p>
     * Provide any channel constant that is valid for your channel mode. To
     * apply to more than one channel, combine channeltype constants using
     * bitwise operators. Refer to this
     ...
     * @link https://php.net/manual/zh/imagick.oilpaintimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/zh/imagick.posterizeimage.php
     * @param int $levels
     * @param bool $dither
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.radialblurimage.php
     * @param float $angle
     * @param int $channel [optional]
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.raiseimage.php
     * @param int $width
     * @param int $height
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/zh/imagick.resampleimage.php
     ...
     * In Imagick 3.0.0 and later the image would be scaled up to size 400x300 as this is the "best fit" for the given dimensions. If bestfit parameter is used both width and height must be given.
     * @link https://php.net/manual/zh/imagick.resizeimage.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Offsets an image
     * @link https://php.net/manual/zh/imagick.rollimage.php
     * @param int $x <p>
     * The X offset.
     * </p>
     * @param int $y <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Rotates an image
     * @link https://php.net/manual/zh/imagick.rotateimage.php
     ...
     * @link https://php.net/manual/zh/imagick.sampleimage.php
     * @param int $columns
     * @param int $rows
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.solarizeimage.php
     * @param int $threshold
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.shadowimage.php
     * @param float $opacity
     * @param float $sigma
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/zh/imagick.setimagebackgroundcolor.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagecompose.php
     * @param int $compose
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setimagecompression.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagedelay.php
     * @param int $delay <p>
     ...
     * @link https://php.net/manual/zh/imagick.setimagedepth.php
     * @param int $depth
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setimagegamma.php
     * @param float $gamma
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setimageiterations.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagemattecolor.php
     * @param mixed $matte
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setimagepage.php
     * @param int $width
     * @param int $height
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/zh/imagick.setimageresolution.php
     * @param float $x_resolution
     * @param float $y_resolution
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.setimagescene.php
     * @param int $scene
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setimagetickspersecond.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image type
     * @link https://php.net/manual/zh/imagick.setimagetype.php
     ...
     * @link https://php.net/manual/zh/imagick.setimageunits.php
     * @param int $units
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sharpens an image
     * @link https://php.net/manual/zh/imagick.sharpenimage.php
     * @param float $radius
     * @param float $sigma
     * @param int $channel [optional]
     * @return bool <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/zh/imagick.shaveimage.php
     * @param int $columns
     * @param int $rows
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.shearimage.php
     * @param mixed $background <p>
     * The background color
     * </p>
     ...
     * @link https://php.net/manual/zh/imagick.spliceimage.php
     * @param int $width
     * @param int $height
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/zh/imagick.pingimage.php
     ...
     * @link https://php.net/manual/zh/imagick.readimagefile.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Displays an image
     * @link https://php.net/manual/zh/imagick.displayimage.php
     ...
     * @link https://php.net/manual/zh/imagick.displayimages.php
     * @param string $servername <p>
     * The X server name
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/zh/imagick.spreadimage.php
     * @param float $radius
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.swirlimage.php
     * @param float $degrees
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.stripimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.queryformats.php
     ...
     * @link https://php.net/manual/zh/imagick.queryfonts.php
     * @param string $pattern [optional] <p>
     * The query pattern
     * </p>
     ...
     * @link https://php.net/manual/zh/imagick.queryfontmetrics.php
     * @param ImagickDraw $properties <p>
     ...
     * @link https://php.net/manual/zh/imagick.steganoimage.php
     ...
     * @link https://php.net/manual/zh/imagick.addnoiseimage.php
     ...
     * @link https://php.net/manual/zh/imagick.motionblurimage.php
     * @param float $radius <p>
     * The radius of the Gaussian, in pixels, not counting the center pixel.
     * </p>
     * @param float $sigma <p>
     ...
     * @link https://php.net/manual/zh/imagick.mosaicimages.php
     * @return Imagick <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
    #[Deprecated]
     ...
     * @link https://php.net/manual/zh/imagick.morphimages.php
     ...
     * @link https://php.net/manual/zh/imagick.minifyimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Transforms an image
     * @link https://php.net/manual/zh/imagick.affinetransformimage.php
     ...
     * @link https://php.net/manual/zh/imagick.averageimages.php
     ...
     * @link https://php.net/manual/zh/imagick.borderimage.php
     * @param mixed $bordercolor <p>
     * ImagickPixel object or a string containing the border color
     * </p>
     * @param int $width <p>
     ...
     * @link https://php.net/manual/zh/imagick.chopimage.php
     * @param int $width <p>
     ...
     * @link https://php.net/manual/zh/imagick.clipimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.clippathimage.php
     ...
     * @link https://php.net/manual/zh/imagick.coalesceimages.php
     * @return Imagick a new Imagick object on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Changes the color value of any pixel that matches target
     * @link https://php.net/manual/zh/imagick.colorfloodfillimage.php
     * @param mixed $fill <p>
     ...
     * @link https://php.net/manual/zh/imagick.colorizeimage.php
     ...
     * @link https://php.net/manual/zh/imagick.compareimagechannels.php
     ...
     * @link https://php.net/manual/zh/imagick.compareimages.php
     ...
     * @link https://php.net/manual/zh/imagick.contrastimage.php
     ...
     * @link https://php.net/manual/zh/imagick.combineimages.php
     * @param int $channelType <p>
     * Provide any channel constant that is valid for your channel mode. To
     * apply to more than one channel, combine channeltype constants using
     * bitwise operators. Refer to this
     ...
     * @link https://php.net/manual/zh/imagick.convolveimage.php
     ...
     * @link https://php.net/manual/zh/imagick.cyclecolormapimage.php
     ...
     * @link https://php.net/manual/zh/imagick.deconstructimages.php
     * @return Imagick a new Imagick object on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.despeckleimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.edgeimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/zh/imagick.embossimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/zh/imagick.enhanceimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.equalizeimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.evaluateimage.php
     * @param int $op <p>
     ...
     * </pre>
     * @link https://php.net/manual/zh/imagick.flattenimages.php
     * @return Imagick Returns an Imagick object containing the merged image.
     * @throws ImagickException Throws ImagickException on error.
     * @since 2.0.0
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a vertical mirror image
     * @link https://php.net/manual/zh/imagick.flipimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a horizontal mirror image
     * @link https://php.net/manual/zh/imagick.flopimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.frameimage.php
     ...
     * @link https://php.net/manual/zh/imagick.fximage.php
     ...
     * @link https://php.net/manual/zh/imagick.gammaimage.php
     * @param float $gamma <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Blurs an image
     * @link https://php.net/manual/zh/imagick.gaussianblurimage.php
     * @param float $radius <p>
     * The radius of the Gaussian, in pixels, not counting the center pixel.
     * </p>
     * @param float $sigma <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimagebackgroundcolor.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageblueprimary.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagebordercolor.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagechanneldepth.php
     * @param int $channel <p>
     * Provide any channel constant that is valid for your channel mode. To apply to more than one channel, combine channel constants using bitwise operators. Defaults to <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     * </p>
     * @return int <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/zh/imagick.getimagechanneldistortion.php
     * @param Imagick $reference <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimagechannelextrema.php
     * @param int $channel <p>
     * Provide any channel constant that is valid for your channel mode. To
     * apply to more than one channel, combine channeltype constants using
     * bitwise operators. Refer to this
     ...
     * @link https://php.net/manual/zh/imagick.getimagechannelmean.php
     * @param int $channel <p>
     * Provide any channel constant that is valid for your channel mode. To
     * apply to more than one channel, combine channeltype constants using
     * bitwise operators. Refer to this
     ...
     * @link https://php.net/manual/zh/imagick.getimagechannelstatistics.php
     * @return array
     * @throws ImagickException on error.
     */
    #[Pure]
     ...
     * @link https://php.net/manual/zh/imagick.getimagecolormapcolor.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimagecolorspace.php
     * @return int <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
    #[Pure]
     ...
     * @link https://php.net/manual/zh/imagick.getimagecompose.php
     * @return int <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
    #[Pure]
     ...
     * @link https://php.net/manual/zh/imagick.getimagedelay.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagedepth.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Compares an image to a reconstructed image
     * @link https://php.net/manual/zh/imagick.getimagedistortion.php
     * @param Imagick $reference <p>
     * Imagick object to compare to.
     * </p>
     * @param int $metric <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimageextrema.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagedispose.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagegamma.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagegreenprimary.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageheight.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagehistogram.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageinterlacescheme.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageiterations.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagemattecolor.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagepage.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagepixelcolor.php
     * @param int $x <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimageprofile.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/zh/imagick.getimageredprimary.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagerenderingintent.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageresolution.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagescene.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagesignature.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagetickspersecond.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagetype.php
     ...
     * @link https://php.net/manual/zh/imagick.getimageunits.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagevirtualpixelmethod.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagewhitepoint.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagewidth.php
     ...
     * @link https://php.net/manual/zh/imagick.getnumberimages.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagetotalinkdensity.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Extracts a region of the image
     * @link https://php.net/manual/zh/imagick.getimageregion.php
     * @param int $width <p>
     ...
     * @link https://php.net/manual/zh/imagick.implodeimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/zh/imagick.levelimage.php
     * @param float $blackPoint <p>
     * The image black point
     * </p>
     * @param float $gamma <p>
     ...
     * @link https://php.net/manual/zh/imagick.magnifyimage.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.mapimage.php
     * @param Imagick $map
     * @param bool $dither
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.mattefloodfillimage.php
     * @param float $alpha <p>
     * The level of transparency: 1.0 is fully opaque and 0.0 is fully
     * transparent.
     * </p>
     ...
     * @link https://php.net/manual/zh/imagick.medianfilterimage.php
     * @param float $radius <p>
     ...
     * @link https://php.net/manual/zh/imagick.negateimage.php
     * @param bool $gray <p>
     ...
     * @link https://php.net/manual/zh/imagick.paintopaqueimage.php
     * @param mixed $target <p>
     ...
     * @link https://php.net/manual/zh/imagick.painttransparentimage.php
     * @param mixed $target <p>
     ...
     * @link https://php.net/manual/zh/imagick.previewimages.php
     * @param int $preview <p>
     ...
     * @link https://php.net/manual/zh/imagick.profileimage.php
     * @param string $name
     ...
     * @link https://php.net/manual/zh/imagick.quantizeimage.php
     ...
     * @link https://php.net/manual/zh/imagick.quantizeimages.php
     * @param int $numberColors
     * @param int $colorspace
     * @param int $treedepth
     * @param bool $dither
     ...
     * @link https://php.net/manual/zh/imagick.reducenoiseimage.php
     * @param float $radius
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.removeimageprofile.php
     * @param string $name
     ...
     * @link https://php.net/manual/zh/imagick.separateimagechannel.php
     * @param int $channel
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.sepiatoneimage.php
     * @param float $threshold
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setimagebias.php
     * @param float $bias
     * @return bool <b>TRUE</b> on success.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setimageblueprimary.php
     * @param float $x
     * @param float $y
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.setimagebordercolor.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagechanneldepth.php
     * @param int $channel
     * @param int $depth
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.setimagecolormapcolor.php
     * @param int $index
     ...
     * @link https://php.net/manual/zh/imagick.setimagecolorspace.php
     * @param int $colorspace <p>
     * One of the COLORSPACE constants
     * </p>
     * @return bool <b>TRUE</b> on success.
     ...
     * @link https://php.net/manual/zh/imagick.setimagedispose.php
     * @param int $dispose
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image size
     * @link https://php.net/manual/zh/imagick.setimageextent.php
     * @param int $columns
     * @param int $rows
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.setimagegreenprimary.php
     * @param float $x
     * @param float $y
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image compression
     * @link https://php.net/manual/zh/imagick.setimageinterlacescheme.php
     ...
     * @link https://php.net/manual/zh/imagick.setimageprofile.php
     * @param string $name
     * @param string $profile
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.setimageredprimary.php
     * @param float $x
     * @param float $y
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.setimagerenderingintent.php
     ...
     * @link https://php.net/manual/zh/imagick.setimagevirtualpixelmethod.php
     * @param int $method
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setimagewhitepoint.php
     * @param float $x
     * @param float $y
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.sigmoidalcontrastimage.php
     * @param bool $sharpen
     * @param float $alpha
     * @param float $beta
     * @param int $channel [optional]
     ...
     * @link https://php.net/manual/zh/imagick.stereoimage.php
     ...
     * @link https://php.net/manual/zh/imagick.textureimage.php
     ...
     * If legacy is true, the behaviour of this function is incorrect, but consistent with how it behaved before Imagick version 3.4.0
     * @link https://php.net/manual/zh/imagick.tintimage.php
     * @param mixed $tint
     * @param mixed $opacity
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sharpens an image
     * @link https://php.net/manual/zh/imagick.unsharpmaskimage.php
     * @param float $radius
     * @param float $sigma
     * @param float $amount
     * @param float $threshold
     ...
     * @link https://php.net/manual/zh/imagick.getimage.php
     ...
     * @link https://php.net/manual/zh/imagick.addimage.php
     ...
     * @link https://php.net/manual/zh/imagick.setimage.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a new image
     * @link https://php.net/manual/zh/imagick.newimage.php
     * @param int $cols <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Creates a new image
     * @link https://php.net/manual/zh/imagick.newpseudoimage.php
     * @param int $columns <p>
     * columns in the new image
     * </p>
     * @param int $rows <p>
     ...
     * @link https://php.net/manual/zh/imagick.getcompression.php
     ...
     * @link https://php.net/manual/zh/imagick.getcompressionquality.php
     ...
     * @link https://php.net/manual/zh/imagick.getcopyright.php
     ...
     * @link https://php.net/manual/zh/imagick.getfilename.php
     ...
     * @link https://php.net/manual/zh/imagick.getformat.php
     ...
     * @link https://php.net/manual/zh/imagick.gethomeurl.php
     ...
     * @link https://php.net/manual/zh/imagick.getinterlacescheme.php
     ...
     * @link https://php.net/manual/zh/imagick.getoption.php
     * @param string $key <p>
     ...
     * @link https://php.net/manual/zh/imagick.getpackagename.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns the page geometry
     * @link https://php.net/manual/zh/imagick.getpage.php
     ...
     * @link https://php.net/manual/zh/imagick.getquantumdepth.php
     ...
     * @link https://php.net/manual/zh/imagick.getquantumrange.php
     ...
     * @link https://php.net/manual/zh/imagick.getreleasedate.php
     ...
     * @link https://php.net/manual/zh/imagick.getresource.php
     * @param int $type <p>
     ...
     * @link https://php.net/manual/zh/imagick.getresourcelimit.php
     * @param int $type <p>
     * Refer to the list of resourcetype constants.
     * </p>
     ...
     * @link https://php.net/manual/zh/imagick.getsamplingfactors.php
     ...
     * @link https://php.net/manual/zh/imagick.getsize.php
     ...
     * @link https://php.net/manual/zh/imagick.getversion.php
     ...
     * @link https://php.net/manual/zh/imagick.setbackgroundcolor.php
     * @param mixed $background
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setcompression.php
     ...
     * @link https://php.net/manual/zh/imagick.setcompressionquality.php
     * @param int $quality
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setfilename.php
     * @param string $filename
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setformat.php
     * @param string $format
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image compression
     * @link https://php.net/manual/zh/imagick.setinterlacescheme.php
     * @param int $interlace_scheme
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Set an option
     * @link https://php.net/manual/zh/imagick.setoption.php
     * @param string $key
     * @param string $value
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.setpage.php
     * @param int $width
     * @param int $height
     * @param int $x
     * @param int $y
     ...
     * @link https://php.net/manual/zh/imagick.setresourcelimit.php
     * @param int $type <p>
     * Refer to the list of resourcetype constants.
     * </p>
     * @param int $limit <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the image resolution
     * @link https://php.net/manual/zh/imagick.setresolution.php
     ...
     * @link https://php.net/manual/zh/imagick.setsamplingfactors.php
     * @param array $factors
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.setsize.php
     * @param int $columns
     * @param int $rows
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.settype.php
     * @param int $image_type
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.valid.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagick.current.php
     ...
     * @link https://php.net/manual/zh/imagick.brightnesscontrastimage.php
     * @param float $brightness
     ...
     * @link https://php.net/manual/zh/imagick.morphology.php
    ...
    /**
     * Applies a custom convolution kernel to the image.
     * @link https://php.net/manual/zh/imagick.filter.php
     ...
     * @link https://php.net/manual/zh/imagick.colormatriximage.php
     ...
     * @link https://php.net/manual/zh/imagick.deleteimageproperty.php
     ...
     * @link https://php.net/manual/zh/imagick.forwardfouriertransformimage.php
     ...
     * @link https://php.net/manual/zh/imagick.getimagecompression.php
     * @return int
     * @since 3.3.0
     */
    #[Pure]
     ...
     * @link https://php.net/manual/zh/imagick.getregistry.php
     * @param string $key
     * @return string|false
     ...
     * @link https://php.net/manual/zh/imagick.getquantum.php
     * @return int
     * @since 3.3.0
     */
     ...
     * @link https://php.net/manual/zh/imagick.identifyformat.php
     ...
     * @link https://php.net/manual/zh/imagick.inversefouriertransformimage.php
     ...
     * @link https://php.net/manual/zh/imagick.listregistry.php
     ...
     * @link https://php.net/manual/zh/imagick.rotationalblurimage.php
     * @param float $angle
     * @param int $CHANNEL
     * @return void
     * @throws ImagickException on error.
     ...
     * @link https://php.net/manual/zh/imagick.selectiveblurimage.php
     * @param float $radius
     * @param float $sigma
     * @param float $threshold
    ...
    /**
     * @link https://php.net/manual/zh/imagick.setimagebiasquantum.php
     * @param string $bias
     * @return void
     * @since 3.3.0
     */
     ...
     * @link https://php.net/manual/zh/imagick.setprogressmonitor.php
     ...
     * @link https://php.net/manual/zh/imagick.setregistry.php
     * @param string $key
     * @param string $value
     * @return void
     * @since 3.3.0
     ...
     * @link https://php.net/manual/zh/imagick.statisticimage.php
     * @param int $type
     * @param int $width
     * @param int $height
     * @param int $channel [optional]
     ...
     *
     * @link https://php.net/manual/zh/imagick.subimagematch.php
 ...
 * @link https://php.net/manual/zh/class.imagickdraw.php
 */
class ImagickDraw
{
     ...
     * @link https://php.net/manual/zh/imagickdraw.construct.php
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfillcolor.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfillalpha.php
     * @param float $opacity <p>
     * fill alpha
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokecolor.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokealpha.php
     * @param float $opacity <p>
     * opacity
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokewidth.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.clear.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a circle
     * @link https://php.net/manual/zh/imagickdraw.circle.php
     * @param float $ox <p>
     * origin x coordinate
     * </p>
     * @param float $oy <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.annotation.php
     * @param float $x <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.settextantialias.php
     * @param bool $antiAlias
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.settextencoding.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfont.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfontfamily.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfontsize.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfontstyle.php
     * @param int $style <p>
     * STYLETYPE_ constant
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfontweight.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns the font
     * @link https://php.net/manual/zh/imagickdraw.getfont.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getfontfamily.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getfontsize.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getfontstyle.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getfontweight.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.destroy.php
     * @return bool No value is returned.
     */
    public function destroy() {}
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a rectangle
     * @link https://php.net/manual/zh/imagickdraw.rectangle.php
     * @param float $x1 <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.roundrectangle.php
     * @param float $x1 <p>
     * x coordinate of the top left corner
     * </p>
     * @param float $y1 <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.ellipse.php
     * @param float $ox
     * @param float $oy
     * @param float $rx
     * @param float $ry
     ...
     * @link https://php.net/manual/zh/imagickdraw.skewx.php
     * @param float $degrees <p>
     * degrees to skew
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.skewy.php
     * @param float $degrees <p>
     * degrees to skew
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.translate.php
     * @param float $x <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a line
     * @link https://php.net/manual/zh/imagickdraw.line.php
     * @param float $sx <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws an arc
     * @link https://php.net/manual/zh/imagickdraw.arc.php
     * @param float $sx <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.matte.php
     * @param float $x <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a polygon
     * @link https://php.net/manual/zh/imagickdraw.polygon.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a point
     * @link https://php.net/manual/zh/imagickdraw.point.php
     * @param float $x <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.gettextdecoration.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.gettextencoding.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfontstretch.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokeantialias.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.settextalignment.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.settextdecoration.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.settextundercolor.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setviewbox.php
     * @param int $x1 <p>
     * left x coordinate
     * </p>
     * @param int $y1 <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.affine.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.bezier.php
     * @param array $coordinates <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.composite.php
     * @param int $compose <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.color.php
     * @param float $x <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Adds a comment
     * @link https://php.net/manual/zh/imagickdraw.comment.php
     * @param string $comment <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.getclippath.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getcliprule.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getclipunits.php
     * @return int an int on success.
     */
    #[Pure]
     ...
     * @link https://php.net/manual/zh/imagickdraw.getfillcolor.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getfillopacity.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getfillrule.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getgravity.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokeantialias.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokecolor.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokedasharray.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokedashoffset.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokelinecap.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokelinejoin.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokemiterlimit.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokeopacity.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getstrokewidth.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.gettextalignment.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.gettextantialias.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.getvectorgraphics.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.gettextundercolor.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathclose.php
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathcurvetoabsolute.php
     * @param float $x1 <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a cubic Bezier curve
     * @link https://php.net/manual/zh/imagickdraw.pathcurvetorelative.php
     * @param float $x1 <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathcurvetoquadraticbezierabsolute.php
     * @param float $x1 <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a quadratic Bezier curve
     * @link https://php.net/manual/zh/imagickdraw.pathcurvetoquadraticbezierrelative.php
     * @param float $x1 <p>
     * starting x coordinate
     * </p>
     * @param float $y1 <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a quadratic Bezier curve
     * @link https://php.net/manual/zh/imagickdraw.pathcurvetoquadraticbeziersmoothabsolute.php
     * @param float $x <p>
     * ending x coordinate
     * </p>
     * @param float $y <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a quadratic Bezier curve
     * @link https://php.net/manual/zh/imagickdraw.pathcurvetoquadraticbeziersmoothrelative.php
     * @param float $x <p>
     * ending x coordinate
     * </p>
     * @param float $y <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a cubic Bezier curve
     * @link https://php.net/manual/zh/imagickdraw.pathcurvetosmoothabsolute.php
     * @param float $x2 <p>
     * x coordinate of the second control point
     * </p>
     * @param float $y2 <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a cubic Bezier curve
     * @link https://php.net/manual/zh/imagickdraw.pathcurvetosmoothrelative.php
     * @param float $x2 <p>
     * x coordinate of the second control point
     * </p>
     * @param float $y2 <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathellipticarcabsolute.php
     * @param float $rx <p>
     * x radius
     * </p>
     * @param float $ry <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws an elliptical arc
     * @link https://php.net/manual/zh/imagickdraw.pathellipticarcrelative.php
     * @param float $rx <p>
     * x radius
     * </p>
     * @param float $ry <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathfinish.php
     * @return bool No value is returned.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a line path
     * @link https://php.net/manual/zh/imagickdraw.pathlinetoabsolute.php
     * @param float $x <p>
     * starting x coordinate
     * </p>
     * @param float $y <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a line path
     * @link https://php.net/manual/zh/imagickdraw.pathlinetorelative.php
     * @param float $x <p>
     * starting x coordinate
     * </p>
     * @param float $y <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathlinetohorizontalabsolute.php
     * @param float $x <p>
     * x coordinate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathlinetohorizontalrelative.php
     * @param float $x <p>
     * x coordinate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathlinetoverticalabsolute.php
     * @param float $y <p>
     * y coordinate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathlinetoverticalrelative.php
     * @param float $y <p>
     * y coordinate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathmovetoabsolute.php
     * @param float $x <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Starts a new sub-path
     * @link https://php.net/manual/zh/imagickdraw.pathmovetorelative.php
     * @param float $x <p>
     * target x coordinate
     * </p>
     * @param float $y <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.pathstart.php
     * @return bool No value is returned.
     */
     ...
     * (PECL imagick 2.0.0)<br/>
     * Draws a polyline
     * @link https://php.net/manual/zh/imagickdraw.polyline.php
     * @param array $coordinates <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.popclippath.php
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.popdefs.php
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.poppattern.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.pushclippath.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.pushdefs.php
     * @return bool No value is returned.
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.pushpattern.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.render.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.rotate.php
     * @param float $degrees <p>
     * degrees to rotate
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.scale.php
     * @param float $x <p>
     * horizontal factor
     * </p>
     * @param float $y <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.setclippath.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setcliprule.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setclipunits.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the opacity to use when drawing using the fill color or fill texture
     * @link https://php.net/manual/zh/imagickdraw.setfillopacity.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfillpatternurl.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setfillrule.php
     * @param int $fill_rule <p>
     * FILLRULE_ constant
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.setgravity.php
     * @param int $gravity <p>
     * GRAVITY_ constant
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokepatternurl.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokedashoffset.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokelinecap.php
     * @param int $linecap <p>
     * LINECAP_ constant
     * </p>
     * @return bool No value is returned.
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokelinejoin.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokemiterlimit.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Specifies the opacity of stroked object outlines
     * @link https://php.net/manual/zh/imagickdraw.setstrokeopacity.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.setvectorgraphics.php
     * @param string $xml <p>
     ...
     * @link https://php.net/manual/zh/imagickdraw.pop.php
     ...
     * @link https://php.net/manual/zh/imagickdraw.push.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagickdraw.setstrokedasharray.php
...
/**
 * @link https://php.net/manual/zh/class.imagickpixeliterator.php
 */
class ImagickPixelIterator implements Iterator
{
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.construct.php
     * @param Imagick $wand
     * @throws ImagickPixelIteratorException on error.
     * @throws ImagickException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.newpixeliterator.php
     * @param Imagick $wand
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns a new pixel iterator
     * @link https://php.net/manual/zh/imagickpixeliterator.newpixelregioniterator.php
     * @param Imagick $wand
     * @param int $x
     * @param int $y
     * @param int $columns
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.getiteratorrow.php
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.setiteratorrow.php
     * @param int $row
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.setiteratorfirstrow.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.setiteratorlastrow.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.getpreviousiteratorrow.php
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.getcurrentiteratorrow.php
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.getnextiteratorrow.php
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.resetiterator.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
    public function resetIterator() {}
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.synciterator.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.destroy.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
    public function destroy() {}
     ...
     * @link https://php.net/manual/zh/imagickpixeliterator.clear.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelIteratorException on error.
     */
    public function clear() {}
...
/**
 * @method clone()
 * @link https://php.net/manual/zh/class.imagickpixel.php
 */
class ImagickPixel
{
    /**
     ...
     * @link https://php.net/manual/zh/imagickpixel.gethsl.php
     ...
     * @link https://php.net/manual/zh/imagickpixel.sethsl.php
     * @param float $hue <p>
     ...
     * @link https://php.net/manual/zh/imagickpixel.construct.php
     ...
     * (PECL imagick 2.0.0)<br/>
     * Sets the color
     * @link https://php.net/manual/zh/imagickpixel.setcolor.php
     ...
     * @link https://php.net/manual/zh/imagickpixel.setcolorvalue.php
     * @param int $color <p>
     ...
     * @link https://php.net/manual/zh/imagickpixel.getcolorvalue.php
     * @param int $color <p>
     ...
     * @link https://php.net/manual/zh/imagickpixel.clear.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelException on failure
     */
    public function clear() {}
     ...
     * @link https://php.net/manual/zh/imagickpixel.destroy.php
     * @return bool <b>TRUE</b> on success.
     * @throws ImagickPixelException on failure
     */
    public function destroy() {}
     ...
     * @link https://php.net/manual/zh/imagickpixel.issimilar.php
     ...
     * (No version information available, might only be in SVN)<br/>
     * Check the distance between this color and another
     * @link https://php.net/manual/zh/imagickpixel.ispixelsimilar.php
     * @param ImagickPixel $color <p>
     * The ImagickPixel object to compare this object against.
     * </p>
     * @param float $fuzz <p>
     ...
     * (PECL imagick 2.0.0)<br/>
     * Returns the color
     * @link https://php.net/manual/zh/imagickpixel.getcolor.php
     ...
     * @link https://php.net/manual/zh/imagickpixel.getcolorasstring.php
     ...
     * @link https://php.net/manual/zh/imagickpixel.getcolorcount.php
     ...
     * @link https://php.net/manual/zh/imagickpixel.ispixelsimilarquantum.php
     * @param string $color
     * @param string $fuzz
     * @return bool
     * @throws ImagickPixelException on failure
     ...
     * @link https://php.net/manual/zh/imagickpixel.getcolorquantum.php
...
/**
 * @link https://php.net/manual/zh/class.imagickkernel.php
 */
class ImagickKernel
{
    /**
     ...
     * @link https://php.net/manual/zh/imagickkernel.addkernel.php
     * @param ImagickKernel $imagickKernel
     * @return void
     * @throws ImagickKernelException on error
     * @since 3.3.0
     ...
     * @link https://php.net/manual/zh/imagickkernel.addunitykernel.php
     * @return void
     * @throws ImagickKernelException on error
     * @since 3.3.0
     */
     ...
     * @link https://php.net/manual/zh/imagickkernel.frombuiltin.php
     ...
     * @link https://php.net/manual/zh/imagickkernel.getmatrix.php
     ...
     * @link https://php.net/manual/zh/imagickkernel.scale.php
     ...
     * @link https://php.net/manual/zh/imagickkernel.separate.php
     * @return void
     * @throws ImagickKernelException on error
     * @since 3.3.0
     */
