 ...
 * @link https://php.net/manual/zh/function.hash.php
 * @param string $algo <p>
 ...
 * @link https://php.net/manual/zh/function.hash-equals.php
 ...
 * @link https://php.net/manual/zh/function.hash-file.php
 * @param string $algo <p>
 * Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..)
 * </p>
 ...
 * @link https://php.net/manual/zh/function.hash-hmac.php
 * @param string $algo <p>
 ...
 * @link https://php.net/manual/zh/function.hash-hmac-file.php
 * @param string $algo <p>
 * Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..) See <b>hash_algos</b> for a list of supported algorithms.<br/>
 * Since 7.2.0 usage of non-cryptographic hash functions (adler32, crc32, crc32b, fnv132, fnv1a32, fnv164, fnv1a64, joaat) was disabled.
 * </p>
 ...
 * @link https://php.net/manual/zh/function.hash-init.php
 * @param string $algo <p>
 ...
 * @link https://php.net/manual/zh/function.hash-update.php
 ...
 * @link https://php.net/manual/zh/function.hash-update-stream.php
 * @param HashContext|resource $context <p>
 * Hashing context returned by {@see hash_init}.
 * </p>
 ...
 * @link https://php.net/manual/zh/function.hash-update-file.php
 * @param HashContext|resource $context <p>
 ...
 * @link https://php.net/manual/zh/function.hash-final.php
 * @param HashContext|resource $context <p>
 * Hashing context returned by {@see hash_init}.
 * </p>
 * @param bool $binary [optional] <p>
 ...
 * @link https://php.net/manual/zh/function.hash-copy.php
 * @param HashContext|resource $context <p>
 * Hashing context returned by {@see hash_init}.
 * </p>
 ...
 * @link https://php.net/manual/zh/function.hash-algos.php
 ...
 * @since 7.1.2
 * Generate a HKDF key derivation of a supplied key input
 * @link https://php.net/manual/zh/function.hash-hkdf.php
 */
#[Pure]
 ...
 * @link https://php.net/manual/zh/function.hash-pbkdf2.php
 * @param string $algo <p>
 * Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..) See <b>hash_algos</b> for a list of supported algorithms.<br/>
 * Since 7.2.0 usage of non-cryptographic hash functions (adler32, crc32, crc32b, fnv132, fnv1a32, fnv164, fnv1a64, joaat) was disabled.
 * </p>
...
/**
 * Generates a key
 * @link https://php.net/manual/zh/function.mhash-keygen-s2k.php
 * @param int $algo <p>
 ...
 * @link https://php.net/manual/zh/function.mhash-get-block-size.php
 * @param int $algo <p>
 ...
 * @link https://php.net/manual/zh/function.mhash-get-hash-name.php
 * @param int $algo <p>
 * The hash ID. One of the <b>MHASH_hashname</b> constants.
 * </p>
 ...
 * @link https://php.net/manual/zh/function.mhash-count.php
...
/**
 * Computes hash
 * @link https://php.net/manual/zh/function.mhash.php
 * @param int $algo <p>
 * The hash ID. One of the <b>MHASH_hashname</b> constants.
 * </p>
 * @param string $data <p>
 ...
 * @link https://php.net/manual/zh/hash.constants.php
 */
define('HASH_HMAC', 1);
