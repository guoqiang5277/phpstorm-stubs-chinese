 ...
 * @link https://php.net/manual/zh/function.sybase-connect.php
 ...
 * @link https://php.net/manual/zh/function.sybase-pconnect.php
 * @param string $servername [optional]
 * @param string $username [optional]
 * @param string $password [optional]
 * @param string $charset [optional]
 ...
 * @link https://php.net/manual/zh/function.sybase-close.php
 ...
 * @link https://php.net/manual/zh/function.sybase-select-db.php
 ...
 * @link https://php.net/manual/zh/function.sybase-query.php
 * @param string $query
 * @param resource $link_identifier [optional]
 ...
 * @link https://php.net/manual/zh/function.sybase-unbuffered-query.php
 * @param string $query
...
/**
 * Frees result memory
 * @link https://php.net/manual/zh/function.sybase-free-result.php
 ...
 * @link https://php.net/manual/zh/function.sybase-get-last-message.php
 ...
 * @link https://php.net/manual/zh/function.sybase-num-rows.php
 * @param resource $result
 ...
 * @link https://php.net/manual/zh/function.sybase-num-fields.php
 * @param resource $result
 ...
 * @link https://php.net/manual/zh/function.sybase-fetch-row.php
 * @param resource $result
...
/**
 * Fetch row as array
 * @link https://php.net/manual/zh/function.sybase-fetch-array.php
 * @param resource $result
 * @return array|false an array that corresponds to the fetched row, or false if there
 * @removed 7.0
 */
 ...
 * @link https://php.net/manual/zh/function.sybase-fetch-assoc.php
 * @param resource $result
 * @return array|false an array that corresponds to the fetched row, or false if there
 * @removed 7.0
 */
 ...
 * @link https://php.net/manual/zh/function.sybase-fetch-object.php
 * @param resource $result
 ...
 * @link https://php.net/manual/zh/function.sybase-data-seek.php
 ...
 * @link https://php.net/manual/zh/function.sybase-fetch-field.php
 * @param resource $result
...
/**
 * Sets field offset
 * @link https://php.net/manual/zh/function.sybase-field-seek.php
 * @param resource $result
...
/**
 * Get result data
 * @link https://php.net/manual/zh/function.sybase-result.php
 * @param resource $result
 * @param int $row
 * @param mixed $field
 * @return string
 ...
 * @link https://php.net/manual/zh/function.sybase-affected-rows.php
 * @param resource $link_identifier [optional]
 ...
 * @link https://php.net/manual/zh/function.sybase-min-client-severity.php
 * @param int $severity
 * @return void
 * @removed 7.0
 */
 ...
 * @link https://php.net/manual/zh/function.sybase-min-server-severity.php
 * @param int $severity
 * @return void
 * @removed 7.0
 */
 ...
 * @link https://php.net/manual/zh/function.sybase-set-message-handler.php
 ...
 * @link https://php.net/manual/zh/function.sybase-deadlock-retry-count.php
