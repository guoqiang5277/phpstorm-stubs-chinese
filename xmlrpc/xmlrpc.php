 ...
 * @link https://php.net/manual/zh/function.xmlrpc-encode.php
 * @param mixed $value
 * @return string
 */
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-decode.php
 * @param string $xml <p>
...
/**
 * Decodes XML into native PHP types
 * @link https://php.net/manual/zh/function.xmlrpc-decode-request.php
 * @param string $xml
 * @param string &$method
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-encode-request.php
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-get-type.php
 * @param mixed $value <p>
 * PHP value
 * </p>
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-set-type.php
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-is-fault.php
 * @param array $arg <p>
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-server-create.php
 * @return resource
 */
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-server-destroy.php
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-server-register-method.php
 * @param resource $server
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-server-call-method.php
 * @param resource $server
 * @param string $xml
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-parse-method-descriptions.php
 * @param string $xml
 * @return array
 */
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-server-add-introspection-data.php
 * @param resource $server
 * @param array $desc
 * @return int
 */
 ...
 * @link https://php.net/manual/zh/function.xmlrpc-server-register-introspection-callback.php
 * @param resource $server
