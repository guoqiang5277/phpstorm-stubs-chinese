 ...
 * on the way.
 * @link https://php.net/manual/zh/class.xmlreader.php
 *
...
class XMLReader
{
     ...
     * @link https://php.net/manual/zh/xmlreader.close.php
     ...
     * @link https://php.net/manual/zh/xmlreader.getattribute.php
     * @param string $name <p>
     ...
     * @link https://php.net/manual/zh/xmlreader.getattributeno.php
     * @param int $index <p>
     ...
     * @link https://php.net/manual/zh/xmlreader.getattributens.php
     * @param string $name <p>
     * The local name.
     * </p>
     ...
     * @link https://php.net/manual/zh/xmlreader.getparserproperty.php
     ...
     * @link https://php.net/manual/zh/xmlreader.isvalid.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/xmlreader.lookupnamespace.php
     ...
     * @link https://php.net/manual/zh/xmlreader.movetoattributeno.php
     * @param int $index <p>
     * The position of the attribute.
     * </p>
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     ...
     * @link https://php.net/manual/zh/xmlreader.movetoattribute.php
     * @param string $name <p>
     * The name of the attribute.
     * </p>
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
    ...
    /**
     * Move cursor to a named attribute
     * @link https://php.net/manual/zh/xmlreader.movetoattributens.php
     * @param string $name <p>
     * The local name.
     * </p>
     * @param string $namespace <p>
     ...
     * @link https://php.net/manual/zh/xmlreader.movetoelement.php
     ...
     * @link https://php.net/manual/zh/xmlreader.movetofirstattribute.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/xmlreader.movetonextattribute.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/xmlreader.open.php
     * @param string $uri <p>
     ...
     * @link https://php.net/manual/zh/xmlreader.read.php
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     * @since 5.1.2
     */
    #[TentativeType]
     ...
     * @link https://php.net/manual/zh/xmlreader.next.php
     ...
     * @link https://php.net/manual/zh/xmlreader.readinnerxml.php
     ...
     * @link https://php.net/manual/zh/xmlreader.readouterxml.php
     ...
     * @link https://php.net/manual/zh/xmlreader.readstring.php
     ...
     * @link https://php.net/manual/zh/xmlreader.setschema.php
    ...
    /**
     * Set parser options
     * @link https://php.net/manual/zh/xmlreader.setparserproperty.php
     * @param int $property <p>
     * One of the parser option
     * constants.
     * </p>
     ...
     * @link https://php.net/manual/zh/xmlreader.setrelaxngschema.php
     * @param string $filename <p>
     ...
     * @link https://php.net/manual/zh/xmlreader.setrelaxngschemasource.php
     ...
     * @link https://php.net/manual/zh/xmlreader.xml.php
     * @param string $source <p>
     ...
     * @link https://php.net/manual/zh/xmlreader.expand.php
